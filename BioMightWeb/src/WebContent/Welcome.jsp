       ...
       <td>
			<TABLE class="tableWelcome">	
   				...
   				<TR>
			 		...
			 		&nbsp;&nbsp;	
			 		<BR>				   		 	
					<div id="bioWindowBox" class=".divLoginContainer" style="height:400px; width:800px; ">
					  <x3d id="bioWindow" showlog="false" showstat="false" style="height:398px; width:798px;"> 
	    				<scene>
		    		        <navigationInfo id="head" headlight='true' type='"EXAMINE"'></navigationInfo>
		        			<background  skyColor="0 0 0"></background>
		    				<inline url="x3d/Logo.x3d"> </inline> 
		    			</scene> 
	    			  </x3d>           
        		  	</div>	
			 		...
			 		<BR>
   	  			 ...
   	  			 <TR>  	
			      <td class="tableDataWelcome">
						<H2><B>BioMight</B> provides hundreds of 3D models that you use to build customized, 
						interactive simulations of the human biology. Build 3D animations for websites, presentations, 
						and class instruction in just minutes.</H2>
					</td>
				</TR>				
   										   
				<TR>
	      		 	<td class="tableDataCW">
			 			Copyright 2018 BioMight Inc.	 
	      			</td>   
   				</TR>
