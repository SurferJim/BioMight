 ...
 * @author SurferJim
 *
 * Representation of the RightForeArmSkin
 * 
 */
...
public class RightForeArmSkin extends Skin  {
		private BioMightPolygons bioMightPolygons;
		private ArrayList<BioMightPropertyView> properties;
		private ArrayList<BioMightMethodView> methods;
		
		
		public RightForeArmSkin()
		{
			this.setImage("images/RightForeArmSkin.jpg");
		...
		public RightForeArmSkin(BioMightPosition bioMightPosition)
		{
			this.setImage("images/RightForeArmSkin.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the RightForeArmSkin at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the RightForeArmSkin
			...
			{	
				...
				coordinateString = 				
					...
					"-9.0, " + yPos + ", -4.5," +
					"-9.0, " + (yPos-height) + ", -3.5," +
					"-11.0, " + (yPos-height) + ", -3.5";		

									
				System.out.println("RightForeArmSkinCoordStr: " + coordinateString); 
				...
				for (int i=0;i<=11;i+=3)
				{
					...
					vertex.setXPos(Double.valueOf(coords[i]));
					vertex.setYPos(Double.valueOf(coords[i+1]));
					vertex.setZPos(Double.valueOf(coords[i+2])-2.0);
					System.out.println("Storing Coordinates: " + j +    "  x: " + coords[i] + " y: " + coords[i+1] + " z: " + coords[i+2]);	
					coordpoint.setBioMightPosition(j++, vertex);
				}
				...
				System.out.println("Created RightForeArmSkin Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set RightForeArmSkin TranslationX: " + position.getXPos());
					...
					System.out.println("RightForeArmSkin Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set RightForeArmSkin Scale...");
				...
				System.out.println("Init3D - Set RightForeArmSkin Transparency...");
				...
				System.out.println("Init3D - Set RightForeArmSkin Color...");
		...
		public String getX3D(boolean snipet) {
			...
			// Assemble the RightForeArmSkin
			String header = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
			"<!DOCTYPE X3D PUBLIC \"ISO//Web3D//DTD X3D 3.0//EN\" \"http://www.web3d.org/specifications/x3d-3.0.dtd\">\n " +
			"<X3D profile='Immersive' >\n" +
			"<head>\n" +
			 "<meta name='BioMightImage' content='RightForeArmSkin.jpg'/>\n" +
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for RightForeArmSkinX: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for RightForeArmSkinY: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for RightForeArmSkinZ: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='RightForeArmSkin'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='RightForeArmSkinPolygon' \n" +
			...
			System.out.println("RightForeArmSkin X3D: " + body);		
