...
public class LeftWrist extends Wrist {
		...
		public LeftWrist()
		{
			this.setImage("images/LeftWrist.jpg");
		...
		public LeftWrist(BioMightPosition bioMightPosition)
		{
			this.setImage("images/LeftWrist.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the LeftWrist at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the LeftWrist
			...
			{	
				...
				System.out.println("LeftWristCoordStr: " + coordinateString); 
				...
				System.out.println("Created LeftWrist Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set LeftWrist TranslationX: " + position.getXPos());
					...
					System.out.println("LeftWrist Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set LeftWrist Scale...");
				...
				System.out.println("Init3D - Set LeftWrist Transparency...");
				...
				System.out.println("Init3D - Set LeftWrist EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for LeftWristX: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for LeftWristY: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for LeftWristZ: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='LeftWrist'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='LeftWristPolygon' \n" +
			...
			System.out.println("LeftWrist X3D: " + body);		
