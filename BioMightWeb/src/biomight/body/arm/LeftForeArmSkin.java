 ...
 * @author SurferJim
 *
 * Representation of the LeftForeArmSkin
 * 
 */
...
public class LeftForeArmSkin extends Skin  {
		private BioMightPolygons bioMightPolygons;
		private ArrayList<BioMightPropertyView> properties;
		private ArrayList<BioMightMethodView> methods;
		
		
		public LeftForeArmSkin()
		{
			this.setImage("images/LeftForeArmSkin.jpg");
		...
		public LeftForeArmSkin(BioMightPosition bioMightPosition)
		{
			this.setImage("images/LeftForeArmSkin.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the LeftForeArmSkin at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the LeftForeArmSkin
			...
			{	
				...
				System.out.println("LeftForeArmSkinCoordStr: " + coordinateString); 
				...
				System.out.println("Created LeftForeArmSkin Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set LeftForeArmSkin TranslationX: " + position.getXPos());
					...
					System.out.println("LeftForeArmSkin Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set LeftForeArmSkin Scale...");
				...
				System.out.println("Init3D - Set LeftForeArmSkin Transparency...");
				...
				System.out.println("Init3D - Set LeftForeArmSkin Color...");
		...
		public String getX3D(boolean snipet) {
			...
			// Assemble the LeftForeArmSkin
			String header = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
			"<!DOCTYPE X3D PUBLIC \"ISO//Web3D//DTD X3D 3.0//EN\" \"http://www.web3d.org/specifications/x3d-3.0.dtd\">\n " +
			"<X3D profile='Immersive' >\n" +
			"<head>\n" +
			 "<meta name='BioMightImage' content='LeftForeArmSkin.jpg'/>\n" +
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for LeftForeArmSkinX: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for LeftForeArmSkinY: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for LeftForeArmSkinZ: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='LeftForeArmSkin'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='LeftForeArmSkinPolygon' \n" +
			...
			System.out.println("LeftForeArmSkin X3D: " + body);		
