...
public class RightArmSkin extends Arm {
		...
		public RightArmSkin(BioMightPosition bioMightPosition)
		{
			this.setImage("images/RightArmSkin.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			initProperties();
			initMethods();
			
			System.out.println("Creating the RightArmSkin at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the RightArmSkin
			...
			{	
				...
				System.out.println("RightArmSkinCoordStr: " + coordinateString); 
				...
				System.out.println("Created RightArmSkin Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set RightArmSkin TranslationX: " + position.getXPos());
					...
					System.out.println("RightArmSkin Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set RightArmSkin Scale...");
				...
				System.out.println("Init3D - Set RightArmSkin Transparency...");
				...
				System.out.println("Init3D - Set RightArmSkin EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for RightArmSkinX: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for RightArmSkinY: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for RightArmSkinZ: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='RightArmSkin'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='RightArmSkinPolygon' \n" +
			...
			System.out.println("RightArmSkin X3D: " + body);		
