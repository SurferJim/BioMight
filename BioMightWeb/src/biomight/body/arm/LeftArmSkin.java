...
public class LeftArmSkin extends Skin {
		...
		public LeftArmSkin(BioMightPosition bioMightPosition)
		{
			this.setImage("images/LeftArmSkin.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			initProperties();
			initMethods();
			
			System.out.println("Creating the LeftArmSkin at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the LeftArmSkin
			...
			{	
				...
				System.out.println("LeftArmSkinCoordStr: " + coordinateString); 
				...
				System.out.println("Created LeftArmSkin Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set LeftArmSkin TranslationX: " + position.getXPos());
					...
					System.out.println("LeftArmSkin Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set LeftArmSkin Scale...");
				...
				System.out.println("Init3D - Set LeftArmSkinSkin Transparency...");
				...
				System.out.println("Init3D - Set LeftArmSkin EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for LeftArmSkinX: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for LeftArmSkinY: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for LeftArmSkinZ: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='LeftArmSkin'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='LeftArmSkinPolygon' \n" +
			...
			System.out.println("LeftArmSkin X3D: " + body);		
