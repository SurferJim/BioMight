 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class RightKnee extends Knee {
	...
	public RightKnee() 
	{
		this.setImage("images/RightKnee.jpg");
		setImageHeight(250);
		setImageWidth(200);
	}

	
	public RightKnee(BioMightPosition bioMightPosition)
	{
		this.setImage("images/RightKnee.jpg");
		...
		System.out.println("Creating the RightKnee at Position: " + bioMightPosition.getXPos());
	...
	public void init3D(BioMightPosition position) {
		...
		// Create a group of polygons to represent the RightKnee
		...
		{	
			...
			System.out.println("RightKneeCoordStr: " + coordinateString); 
			...
			System.out.println("Created RightKnee Polygon");		
			...
			if (position != null)
			{
				...
				System.out.println("Init3D - Set RightKnee TranslationX: " + position.getXPos());
				...
				System.out.println("RightKnee Polygon - init3d - position is null!");
			
			// Set up the scale
			bioMightPolygon.getScale().setXPos(1);
			bioMightPolygon.getScale().setYPos(1);
			bioMightPolygon.getScale().setZPos(1);
			System.out.println("Init3D - Set RightKnee Scale...");
			...
			System.out.println("Init3D - Set RightKnee Transparency...");
			...
			System.out.println("Init3D - Set RightKnee EpitheliumTissue Color...");
	...
	public String getX3D(boolean snipet) {
		...
		{				
			...
			{	
				...
				System.out.println("Getting X3D for RightKneeX: " + bioMightPolygon.getTranslation().getXPos());
				System.out.println("Getting X3D for RightKneeY: " + bioMightPolygon.getTranslation().getYPos());
				System.out.println("Getting X3D for RightKneeZ: " + bioMightPolygon.getTranslation().getZPos());
				// Change the height and width based on the displacement.
			
			body += "<Transform DEF='RightKnee'\n" +
			    ...
			    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
			 	"</Appearance>\n" +			    
			 	"<IndexedFaceSet DEF='RightKneePolygon' \n" +
		...
		System.out.println("RightKnee X3D: " + body);		
