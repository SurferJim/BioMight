...
public class RightLegSkin extends Skin {
		...
		public RightLegSkin()
		{
			this.setImage("images/RightLegSkin.jpg");
		...
		public RightLegSkin(BioMightPosition bioMightPosition)
		{
			this.setImage("images/RightLegSkin.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the RightLegSkin
			...
			{	
				...
				System.out.println("RightLegSkinCoordStr: " + coordinateString); 
				...
				System.out.println("Created RightLegSkin Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set RightLegSkin TranslationX: " + position.getXPos());
					...
					System.out.println("RightLegSkin Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set RightLegSkin Scale...");
				...
				System.out.println("Init3D - Set RightLegSkin Transparency...");
				...
				System.out.println("Init3D - Set RightLegSkin EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			// Assemble the Right Leg Skin
			String header = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
			"<!DOCTYPE X3D PUBLIC \"ISO//Web3D//DTD X3D 3.0//EN\" \"http://www.web3d.org/specifications/x3d-3.0.dtd\">\n " +
			"<X3D profile='Immersive' >\n" +
			"<head>\n" +
			 "<meta name='BioMightImage' content='RightLegSkin.jpg'/>\n" +
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for RightLegSkinX: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for RightLegSkinY: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for RightLegSkinZ: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='RightLegSkin'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='RightLegSkinPolygon' \n" +
			...
			System.out.println("RightLegSkin X3D: " + body);		
