...
public class LeftCnemisSkin extends Cnemis {
		...
		public LeftCnemisSkin(BioMightPosition bioMightPosition)
		{
			this.setImage("images/LeftCnemis.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the LeftCnemis
			...
			{	
				...
				System.out.println("LeftCnemisCoordStr: " + coordinateString); 
				...
				System.out.println("Created LeftCnemis Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set LeftCnemis TranslationX: " + position.getXPos());
					...
					System.out.println("LeftCnemis Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set LeftCnemis Scale...");
				...
				System.out.println("Init3D - Set LeftCnemis Transparency...");
				...
				System.out.println("Init3D - Set LeftCnemis EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for LeftCnemisX: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for LeftCnemisY: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for LeftCnemisZ: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='LeftCnemis'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='LeftCnemisPolygon' \n" +
