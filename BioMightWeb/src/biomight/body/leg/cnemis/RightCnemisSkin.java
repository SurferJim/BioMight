 ...
 * @author SurferJim
 *
 * Representation of the Right Cnemis
 * 
 */
...
public class RightCnemisSkin extends Cnemis {
		private BioMightPolygons bioMightPolygons;
		private ArrayList<BioMightPropertyView> properties;
		private ArrayList<BioMightMethodView> methods;
		
		
		public RightCnemisSkin()
		{
			this.setImage("images/RightCnemis.jpg");
		...
		public RightCnemisSkin(BioMightPosition bioMightPosition)
		{
			this.setImage("images/RightCnemis.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the RightCnemis at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the RightCnemis
			...
			{	
				...
				System.out.println("RightCnemisCoordStr: " + coordinateString); 
				...
				System.out.println("Created RightCnemis Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set RightCnemis TranslationX: " + position.getXPos());
					...
					System.out.println("RightCnemis Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set RightCnemis Scale...");
				...
				System.out.println("Init3D - Set RightCnemis Transparency...");
				...
				System.out.println("Init3D - Set RightCnemis EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for RightCnemisX: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for RightCnemisY: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for RightCnemisZ: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='RightCnemis'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='RightCnemisPolygon' \n" +
			...
			System.out.println("RightCnemis X3D: " + body);		
