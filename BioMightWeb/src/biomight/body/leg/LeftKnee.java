 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class LeftKnee extends Knee {
	...
	public LeftKnee() 
	{
		this.setImage("images/LeftKnee.jpg");
		setImageHeight(250);
		setImageWidth(200);
	}

	
	public LeftKnee(BioMightPosition bioMightPosition)
	{
		this.setImage("images/LeftKnee.jpg");
		...
		System.out.println("Creating the LeftKnee at Position: " + bioMightPosition.getXPos());
	...
	public void init3D(BioMightPosition position) {
		...
		// Create a group of polygons to represent the LeftKnee
		...
		{	
			...
			System.out.println("LeftKneeCoordStr: " + coordinateString); 
			...
			System.out.println("Created LeftKnee Polygon");		
			...
			if (position != null)
			{
				...
				System.out.println("Init3D - Set LeftKnee TranslationX: " + position.getXPos());
				...
				System.out.println("LeftKnee Polygon - init3d - position is null!");
			
			// Set up the scale
			bioMightPolygon.getScale().setXPos(1);
			bioMightPolygon.getScale().setYPos(1);
			bioMightPolygon.getScale().setZPos(1);
			System.out.println("Init3D - Set LeftKnee Scale...");
			...
			System.out.println("Init3D - Set LeftKnee Transparency...");
			...
			System.out.println("Init3D - Set LeftKnee EpitheliumTissue Color...");
	...
	public String getX3D(boolean snipet) {
		...
		{				
			...
			{	
				...
				System.out.println("Getting X3D for LeftKneeX: " + bioMightPolygon.getTranslation().getXPos());
				System.out.println("Getting X3D for LeftKneeY: " + bioMightPolygon.getTranslation().getYPos());
				System.out.println("Getting X3D for LeftKneeZ: " + bioMightPolygon.getTranslation().getZPos());
				// Change the height and width based on the displacement.
			
			body += "<Transform DEF='LeftKnee'\n" +
			    ...
			    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
			 	"</Appearance>\n" +			    
			 	"<IndexedFaceSet DEF='LeftKneePolygon' \n" +
		...
		System.out.println("LeftKnee X3D: " + body);		
