...
public class LeftLegSkin extends Skin {
		...
		public LeftLegSkin(BioMightPosition bioMightPosition)
		{
			this.setImage("images/LeftLegSkin.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			initProperties();
			initMethods();
		...
		public void initProperties() {
			...
			property.setCanonicalName(Constants.Skin);
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the LeftLeg
			...
			{	
				...
				System.out.println("LeftLegSkinCoordStr: " + coordinateString); 
				...
				for (int i=0;i<=11;i+=3)
				{
					...
					vertex.setXPos(Double.valueOf(coords[i]));
					vertex.setYPos(Double.valueOf(coords[i+1]));
					vertex.setZPos(Double.valueOf(coords[i+2])-4.0);
					System.out.println("Storing Coordinates: " + j +    "  x: " + coords[i] + " y: " + coords[i+1] + " z: " + coords[i+2]);	
					coordpoint.setBioMightPosition(j++, vertex);
				}
				...
				System.out.println("Created LeftLegSkin Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set LeftLegSkin TranslationX: " + position.getXPos());
					...
					System.out.println("LeftLegSkin Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set LeftLegSkin Scale...");
				...
				System.out.println("Init3D - Set LeftLegSkin Transparency...");
				...
				System.out.println("Init3D - Set LeftLegSkin EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			// Assemble the LeftLegSkin
			String header = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
			"<!DOCTYPE X3D PUBLIC \"ISO//Web3D//DTD X3D 3.0//EN\" \"http://www.web3d.org/specifications/x3d-3.0.dtd\">\n " +
			"<X3D profile='Immersive' >\n" +
			"<head>\n" +
			 "<meta name='BioMightImage' content='LeftLegSkin.jpg'/>\n" +
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for LeftLegSkinX: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for LeftLegSkinY: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for LeftLegSkinZ: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='LeftLegSkin'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='LeftLegSkinPolygon' \n" +
			...
			System.out.println("LeftLegSkin X3D: " + body);		
