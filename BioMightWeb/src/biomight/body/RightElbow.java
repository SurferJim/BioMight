 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class RightElbow extends Elbow {
	private BioMightPolygons bioMightPolygons;
	

	public RightElbow() 
	{
		this.setImage("images/RightElbow.jpg");
		setImageHeight(250);
		setImageWidth(200);
	}

	
	public RightElbow(BioMightPosition bioMightPosition)
	{
		this.setImage("images/RightElbow.jpg");
		...
		System.out.println("Creating the RightElbow at Position: " + bioMightPosition.getXPos());
	...
	public void init3D(BioMightPosition position) {
		...
		// Create a group of polygons to represent the RightElbow
		...
		{	
			...
			System.out.println("RightElbowCoordStr: " + coordinateString); 
			...
			System.out.println("Created RightElbow Polygon");		
			...
			if (position != null)
			{
				...
				System.out.println("Init3D - Set RightElbow TranslationX: " + position.getXPos());
				...
				System.out.println("RightElbow Polygon - init3d - position is null!");
			
			// Set up the scale
			bioMightPolygon.getScale().setXPos(1);
			bioMightPolygon.getScale().setYPos(1);
			bioMightPolygon.getScale().setZPos(1);
			System.out.println("Init3D - Set RightElbow Scale...");
			...
			System.out.println("Init3D - Set RightElbow Transparency...");
			...
			System.out.println("Init3D - Set RightElbow EpitheliumTissue Color...");
	...
	public String getX3D(boolean snipet) {
		...
		{				
			...
			{	
				...
				System.out.println("Getting X3D for RightElbowX: " + bioMightPolygon.getTranslation().getXPos());
				System.out.println("Getting X3D for RightElbowY: " + bioMightPolygon.getTranslation().getYPos());
				System.out.println("Getting X3D for RightElbowZ: " + bioMightPolygon.getTranslation().getZPos());
				// Change the height and width based on the displacement.
			
			body += "<Transform DEF='RightElbow'\n" +
			    ...
			    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
			 	"</Appearance>\n" +			    
			 	"<IndexedFaceSet DEF='RightElbowPolygon' \n" +
		...
		System.out.println("RightElbow X3D: " + body);		
