...
* @author SurferJim
*
* Representation of the Left Middle Finger
* 
*/
...
public class LeftMiddleFinger extends RingFinger {
		...
		{
			this.setImage("images/LeftMiddleFinger.jpg");
		...
		public LeftMiddleFinger(BioMightPosition bioMightPosition)
		{
			this.setImage("images/LeftMiddleFinger.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the LeftMiddleFinger at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the LeftMiddleFinger
			...
			{	
				...
				System.out.println("LeftMiddleFingerCoordStr: " + coordinateString); 
				...
				System.out.println("Created LeftMiddleFinger Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set LeftMiddleFinger TranslationX: " + position.getXPos());
					...
					System.out.println("LeftMiddleFinger Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set LeftMiddleFinger Scale...");
				...
				System.out.println("Init3D - Set LeftMiddleFinger Transparency...");
				...
				System.out.println("Init3D - Set LeftMiddleFinger EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for LeftMiddleFingerX: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for LeftMiddleFingerY: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for LeftMiddleFingerZ: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='LeftMiddleFinger'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='LeftMiddleFingerPolygon' \n" +
			...
			System.out.println("LeftMiddleFinger X3D: " + body);		
