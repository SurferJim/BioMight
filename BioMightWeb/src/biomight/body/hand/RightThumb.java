...
* @author SurferJim
*
* Representation of the Right Thumb
* 
*/
...
public class RightThumb extends Thumb {
		...
		public RightThumb()
		{
			this.setImage("images/RightThumb.jpg");
		...
		public RightThumb(BioMightPosition bioMightPosition)
		{
			this.setImage("images/RightThumb.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the RightThumb at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the RightThumb
			...
			{	
				...
				System.out.println("RightThumbCoordStr: " + coordinateString); 
				...
				System.out.println("Created RightThumb Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set RightThumb TranslationX: " + position.getXPos());
					...
					System.out.println("RightThumb Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set RightThumb Scale...");
				...
				System.out.println("Init3D - Set RightThumb Transparency...");
				...
				System.out.println("Init3D - Set RightThumb EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for RightThumbX: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for RightThumbY: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for RightThumbZ: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='RightThumb'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='RightThumbPolygon' \n" +
			...
			System.out.println("RightThumb X3D: " + body);		
