 ...
 * @author SurferJim
 *
 * Representation of the Right Palm
 * 
 */
...
public class RightPalm extends Palm {
		...
		public RightPalm()
		{
			this.setImage("images/RightPalm.jpg");
		...
		public RightPalm(BioMightPosition bioMightPosition)
		{
			this.setImage("images/RightPalm.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the RightPalm at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the RightPalm
			...
			{	
				...
				System.out.println("RightPalmCoordStr: " + coordinateString); 
				...
				System.out.println("Created RightPalm Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set RightPalm TranslationX: " + position.getXPos());
					...
					System.out.println("RightPalm Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set RightPalm Scale...");
				...
				System.out.println("Init3D - Set RightPalm Transparency...");
				...
				System.out.println("Init3D - Set RightPalm EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for RightPalmX: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for RightPalmY: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for RightPalmZ: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='RightPalm'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='RightPalmPolygon' \n" +
			...
			System.out.println("RightPalm X3D: " + body);		
