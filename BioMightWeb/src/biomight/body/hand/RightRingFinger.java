...
* @author SurferJim
*
* Representation of the Right Ring Finger
* 
*/
...
public class RightRingFinger extends RingFinger {
		...
		{
			this.setImage("images/RightRingFinger.jpg");
		...
		public RightRingFinger(BioMightPosition bioMightPosition)
		{
			this.setImage("images/RightRingFinger.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the RightRingFinger at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the RightRingFinger
			...
			{	
				...
				"-11.0, " + yPos + ", -4.5," +
				"-10.5, " + yPos + ", -4.5," +
				"-10.5, " + (yPos-height) + ", -4.5," +
				"-11.0, " + (yPos-height) + ", -4.5";		
				
									
				System.out.println("RightRingFingerCoordStr: " + coordinateString); 
				...
				System.out.println("Created RightRingFinger Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set RightRingFinger TranslationX: " + position.getXPos());
					...
					System.out.println("RightRingFinger Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set RightRingFinger Scale...");
				...
				System.out.println("Init3D - Set RightRingFinger Transparency...");
				...
				System.out.println("Init3D - Set RightRingFinger EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for RightRingFingerX: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for RightRingFingerY: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for RightRingFingerZ: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='RightRingFinger'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='RightRingFingerPolygon' \n" +
			...
			System.out.println("RightRingFinger X3D: " + body);		
