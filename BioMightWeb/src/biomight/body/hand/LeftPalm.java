 ...
 * @author SurferJim
 *
 * Representation of the Left Palm
 * 
 */
...
public class LeftPalm extends Palm {
		...
		public LeftPalm()
		{
			this.setImage("images/LeftPalm.jpg");
		...
		public LeftPalm(BioMightPosition bioMightPosition)
		{
			this.setImage("images/LeftPalm.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the LeftPalm at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the LeftPalm
			...
			{	
				...
				System.out.println("LeftPalmCoordStr: " + coordinateString); 
				...
				System.out.println("Created LeftPalm Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set LeftPalm TranslationX: " + position.getXPos());
					...
					System.out.println("LeftPalm Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set LeftPalm Scale...");
				...
				System.out.println("Init3D - Set LeftPalm Transparency...");
				...
				System.out.println("Init3D - Set LeftPalm EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for LeftPalmX: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for LeftPalmY: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for LeftPalmZ: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='LeftPalm'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='LeftPalmPolygon' \n" +
			...
			System.out.println("LeftPalm X3D: " + body);		
