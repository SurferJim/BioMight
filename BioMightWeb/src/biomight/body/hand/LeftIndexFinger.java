...
* @author SurferJim
*
* Representation of the Left Index Finger
* 
*/
...
public class LeftIndexFinger extends RingFinger {
		...
		{
			this.setImage("images/LeftIndexFinger.jpg");
		...
		public LeftIndexFinger(BioMightPosition bioMightPosition)
		{
			this.setImage("images/LeftIndexFinger.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the LeftIndexFinger at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the LeftIndexFinger
			...
			{	
				...
				System.out.println("LeftIndexFingerCoordStr: " + coordinateString); 
				...
				System.out.println("Created LeftIndexFinger Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set LeftIndexFinger TranslationX: " + position.getXPos());
					...
					System.out.println("LeftIndexFinger Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set LeftIndexFinger Scale...");
				...
				System.out.println("Init3D - Set LeftIndexFinger Transparency...");
				...
				System.out.println("Init3D - Set LeftIndexFinger EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for LeftIndexFingerX: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for LeftIndexFingerY: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for LeftIndexFingerZ: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='LeftIndexFinger'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='LeftIndexFingerPolygon' \n" +
			...
			System.out.println("LeftIndexFinger X3D: " + body);		
