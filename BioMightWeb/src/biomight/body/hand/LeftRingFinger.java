...
* @author SurferJim
*
* Representation of the Left Ring Finger
* 
*/
...
public class LeftRingFinger extends RingFinger {
		...
		{
			this.setImage("images/LeftRingFinger.jpg");
		...
		public LeftRingFinger(BioMightPosition bioMightPosition)
		{
			this.setImage("images/LeftRingFinger.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the LeftRingFinger at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the LeftRingFinger
			...
			{	
				...
				System.out.println("LeftRingFingerCoordStr: " + coordinateString); 
				...
				System.out.println("Created LeftRingFinger Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set LeftRingFinger TranslationX: " + position.getXPos());
					...
					System.out.println("LeftRingFinger Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set LeftRingFinger Scale...");
				...
				System.out.println("Init3D - Set LeftRingFinger Transparency...");
				...
				System.out.println("Init3D - Set LeftRingFinger EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for LeftRingFingerX: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for LeftRingFingerY: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for LeftRingFingerZ: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='LeftRingFinger'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='LeftRingFingerPolygon' \n" +
			...
			System.out.println("LeftRingFinger X3D: " + body);		
