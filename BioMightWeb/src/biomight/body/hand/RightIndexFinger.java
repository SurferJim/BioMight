...
* @author SurferJim
*
* Representation of the Right Index Finger
* 
*/
...
public class RightIndexFinger extends RingFinger {
		...
		{
			this.setImage("images/RightIndexFinger.jpg");
		...
		public RightIndexFinger(BioMightPosition bioMightPosition)
		{
			this.setImage("images/RightIndexFinger.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the RightIndexFinger at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the RightIndexFinger
			...
			{	
				...
				System.out.println("RightIndexFingerCoordStr: " + coordinateString); 
				...
				System.out.println("Created RightIndexFinger Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set RightIndexFinger TranslationX: " + position.getXPos());
					...
					System.out.println("RightIndexFinger Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set RightIndexFinger Scale...");
				...
				System.out.println("Init3D - Set RightIndexFinger Transparency...");
				...
				System.out.println("Init3D - Set RightIndexFinger EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for RightIndexFingerX: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for RightIndexFingerY: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for RightIndexFingerZ: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='RightIndexFinger'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='RightIndexFingerPolygon' \n" +
			...
			System.out.println("RightIndexFinger X3D: " + body);		
