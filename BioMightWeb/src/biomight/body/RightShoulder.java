 ...
 * @author SurferJim
 *
 * Representation of the RightShoulder
 * 
 */
...
public class RightShoulder extends Shoulder {
		...
		{
			this.setImage("images/RightShoulder.jpg");
		...
		public RightShoulder(BioMightPosition bioMightPosition)
		{
			this.setImage("images/RightShoulder.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the RightShoulder at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the RightShoulder
			...
			{	
				...
				coordinateString = 				
					"-7.0, " + yPos + ", -4.5," +
					"-5.0, " + yPos + ", -4.5," +
					"-7.25, " + (yPos-height) + ", -4.5," +
					"-4.75, " + (yPos-height) + ", -4.5";		

									
				System.out.println("RightShoulderCoordStr: " + coordinateString); 
				...
				System.out.println("Created RightShoulder Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set RightShoulder TranslationX: " + position.getXPos());
					...
					System.out.println("RightShoulder Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set RightShoulder Scale...");
				...
				System.out.println("Init3D - Set RightShoulder Transparency...");
				...
				System.out.println("Init3D - Set RightShoulder EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for RightShoulderX: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for RightShoulderY: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for RightShoulderZ: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='RightShoulder'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='RightShoulderPolygon' \n" +
			...
			System.out.println("RightShoulder X3D: " + body);		
