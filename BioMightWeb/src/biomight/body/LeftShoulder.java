 ...
 * @author SurferJim
 *
 * Representation of the LeftShoulder
 * 
 */
...
public class LeftShoulder extends Shoulder {
		...
		public LeftShoulder()
		{
			this.setImage("images/LeftShoulder.jpg");
		...
		public LeftShoulder(BioMightPosition bioMightPosition)
		{
			this.setImage("images/LeftShoulder.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the LeftShoulder at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the LeftShoulder
			...
			{	
				...
				System.out.println("LeftShoulderCoordStr: " + coordinateString); 
				...
				System.out.println("Created LeftShoulder Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set LeftShoulder TranslationX: " + position.getXPos());
					...
					System.out.println("LeftShoulder Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set LeftShoulder Scale...");
				...
				System.out.println("Init3D - Set LeftShoulder Transparency...");
				...
				System.out.println("Init3D - Set LeftShoulder EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for LeftShoulderX: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for LeftShoulderY: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for LeftShoulderZ: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='LeftShoulder'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='LeftShoulderPolygon' \n" +
			...
			System.out.println("LeftShoulder X3D: " + body);		
