...
public class RightFoot extends Foot {
		...
		public RightFoot()
		{
			this.setImage("images/RightFoot.jpg");
		...
		public RightFoot(BioMightPosition bioMightPosition)
		{
			this.setImage("images/RightFoot.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the RightFoot at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the RightFoot
			...
			{	
				...
				coordinateString = 				
					"7.0, " + yPos + ", -3.5," +
					"14.0, " + yPos + ", -3.5," +
					"14.0, " + (yPos-height) + ", -3.5," +
					"7.0, " + (yPos-height) + ", -3.5";			

									
				System.out.println("RightFootCoordStr: " + coordinateString); 
				...
				for (int i=0;i<=11;i+=3)
				{
					...
					vertex.setXPos(Double.valueOf(coords[i]));
					vertex.setYPos(Double.valueOf(coords[i+1]));
					vertex.setZPos(Double.valueOf(coords[i+2])-2.5);
					System.out.println("Storing Coordinates: " + j +    "  x: " + coords[i] + " y: " + coords[i+1] + " z: " + coords[i+2]);	
					coordpoint.setBioMightPosition(j++, vertex);
				}
				...
				System.out.println("Created RightFoot Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set RightFoot TranslationX: " + position.getXPos());
					...
					System.out.println("RightFoot Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set RightFoot Scale...");
				...
				System.out.println("Init3D - Set RightFoot Transparency...");
				...
				System.out.println("Init3D - Set RightFoot Color...");
		...
		public String getX3D(boolean snipet) {
			...
			// Assemble the RightFoot
			String header = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
			"<!DOCTYPE X3D PUBLIC \"ISO//Web3D//DTD X3D 3.0//EN\" \"http://www.web3d.org/specifications/x3d-3.0.dtd\">\n " +
			"<X3D profile='Immersive' >\n" +
			"<head>\n" +
			 "<meta name='BioMightImage' content='RightFoot.jpg'/>\n" +
			...
			System.out.println("*******Getting X3D for RightFoot*****");
			String body = "";
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for RightFootX: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for RightFootY: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for RightFootZ: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='RightFoot'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='RightFootPolygon' \n" +
			...
			System.out.println("RightFoot X3D: " + body);		
