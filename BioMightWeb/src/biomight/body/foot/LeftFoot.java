...
public class LeftFoot extends Foot {
		...
		public LeftFoot()
		{
			this.setImage("images/LeftFoot.jpg");
		...
		public LeftFoot(BioMightPosition bioMightPosition)
		{
			this.setImage("images/LeftFoot.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the LeftFoot at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the LeftFoot
			...
			{	
				...
				System.out.println("LeftFootCoordStr: " + coordinateString); 
				...
				System.out.println("Created LeftFoot Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set LeftFoot TranslationX: " + position.getXPos());
					...
					System.out.println("LeftFoot Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set LeftFoot Scale...");
				...
				System.out.println("Init3D - Set LeftFoot Transparency...");
				...
				System.out.println("Init3D - Set LeftFoot Color...");
		...
		public String getX3D(boolean snipet) {
			...
			// Assemble the LeftFoot
			String header = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
			"<!DOCTYPE X3D PUBLIC \"ISO//Web3D//DTD X3D 3.0//EN\" \"http://www.web3d.org/specifications/x3d-3.0.dtd\">\n " +
			"<X3D profile='Immersive' >\n" +
			"<head>\n" +
			 "<meta name='BioMightImage' content='LeftFoot.jpg'/>\n" +
			...
			System.out.println("*******Getting X3D for LeftFoot*****");
			String body = "";
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for LeftFootX: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for LeftFootY: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for LeftFootZ: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='LeftFoot'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='LeftFootPolygon' \n" +
			...
			System.out.println("LeftFoot X3D: " + body);		
