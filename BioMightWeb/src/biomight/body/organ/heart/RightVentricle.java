 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class RightVentricle extends BioMightBase {
		...
		public RightVentricle()
		{
			create(Constants.RightVentricle, null);
		}

		public RightVentricle(String parentID)
		{
			create(parentID, null);
		}
		
		public RightVentricle(String parentID, ArrayList<BioMightMethodView> bioMightMethods)
		{
		...
		{
			this.setImage("images/RightVentricle.jpg");
			...
			try {
				// Get the information from the database via the Enterprise Bean		
				System.out.println("Getting RightVentricleInfo for ParentID: " + parentID);
				InitialContext ctx = new InitialContext();
				BioMightBeanLocal bioMightBean = (BioMightBeanLocal) ctx.lookup(Constants.BioMightBeanRef);
				bioMightTransforms = bioMightBean.getComponents(Constants.RightVentricleRef, parentID);
				System.out.println("Have RightVentricle Info from EJB");   	
			}catch (Exception e) { 
				System.out.println("Exception Getting Components - RightVentricle");
				throw new ServerException("Remote Exception getComponents():", e); 	
			}
				
			// Run through the collection of RightVentricles and build them into the model
			// In the default case, we get one instance of the RightVentricle for each eye
			ArrayList transforms = bioMightTransforms.getTransforms();
			System.out.println("RightVentricle NumTransforms: " + transforms.size());
			for (int i=0; i<transforms.size(); i++)
			{
				// Get the information for the eye we are creating
				BioMightTransform bioMightTransform = (BioMightTransform) transforms.get(i);
				System.out.println("Created RightVentricle: " + bioMightTransform.getName() + "  " + bioMightTransform.getId());
				this.componentID = bioMightTransform.getId();
				
				System.out.println("Creating RightVentricle Endothelium: " + bioMightTransform.getId());				
			...
			System.out.println("CreateRightVentricle Completed");
			...
			if (bioMightMethods != null){
				System.out.println("EXECUTING RightVentricle METHODS: " + bioMightMethods.size());
		...
		public String getX3D(boolean snipet) {
			...
			System.out.println("RightVentricle X3D: " + body);		
