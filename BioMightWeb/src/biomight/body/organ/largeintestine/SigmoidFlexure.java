...
public class SigmoidFlexure extends BioMightBase {
	private ArrayList<BioMightPropertyView> properties;
	private ArrayList<BioMightMethodView> methods;
	
	
	public SigmoidFlexure()
	{
		this.setImage("images/SigmoidFlexure.jpg");
	...
	public String getX3D(boolean snipet) {
		...
		System.out.println("SigmoidFlexure X3D: " + body);		
