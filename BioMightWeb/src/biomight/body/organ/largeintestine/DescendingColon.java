 ...
 * @author SurferJim *
 * 
 * Representation of the DescendingColon
 * 
 */

public class DescendingColon extends Organ {
	private ArrayList<BioMightPropertyView> properties;
	private ArrayList<BioMightMethodView> methods;
	
	
	public DescendingColon()
	{
		this.setImage("images/DescendingColon.jpg");
	...
	public String getX3D(boolean snipet) {
		...
		// Assemble the DescendingColon
		String header = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
		"<!DOCTYPE X3D PUBLIC \"ISO//Web3D//DTD X3D 3.0//EN\" \"http://www.web3d.org/specifications/x3d-3.0.dtd\">\n " +
		"<X3D profile='Immersive' >\n" +
		"<head>\n" +
		 "<meta name='BioMightImage' content='DescendingColon.jpg'/>\n" +
		...
		"<Scene>\n" +
		"<WorldInfo\n" +
		"title='DescendingColon'\n" +
		"info='\"BioMight Generated X3D\"'/>\n";		

		String body = "";//leftEar.getX3D(true) + rightEar.getX3D(true);  
		System.out.println("DescendingColon X3D: " + body);		
