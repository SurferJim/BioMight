 ...
 * @author SurferJim
 *
 * Representation of the ThymusLeftLateralLobe
 * 
 */
public class ThymusLeftLateralLobe extends BioMightBase {
	private ArrayList<BioMightPropertyView> properties;
	private ArrayList<BioMightMethodView> methods;
	
	
	public ThymusLeftLateralLobe()
	{
		this.setImage("images/ThymusLeftLateralLobe.jpg");
