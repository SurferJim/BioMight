 ...
 * @author SurferJim
 *
 * Representation of the Right Wrist
 * 
 */
...
public class RightWrist extends Wrist {
		...
		public RightWrist()
		{
			this.setImage("images/RightWrist.jpg");
		...
		public RightWrist(BioMightPosition bioMightPosition)
		{
			this.setImage("images/RightWrist.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the RightWrist at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the RightWrist
			...
			{	
				...
				System.out.println("RightWristCoordStr: " + coordinateString); 
				...
				System.out.println("Created RightWrist Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set RightWrist TranslationX: " + position.getXPos());
					...
					System.out.println("RightWrist Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set RightWrist Scale...");
				...
				System.out.println("Init3D - Set RightWrist Transparency...");

				bioMightColor = new BioMightColor();
				if (alpha == 0){
					bioMightColor.setRed(1.0);
					bioMightColor.setBlue(0.4);
					bioMightColor.setGreen(0.80);
				}
				...
				System.out.println("Init3D - Set RightWrist EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for RightWristX: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for RightWristY: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for RightWristZ: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='RightWrist'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='RightWristPolygon' \n" +
			...
			System.out.println("RightWrist X3D: " + body);		
