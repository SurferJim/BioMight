 ...
 * @author SurferJim
 *
 * Representation of the LeftPinnaAntiHelix.  Comprised of cartilage
 * 
 */

public class LeftPinnaAntiHelix  extends PinnaAntiHelix {
	...
	public LeftPinnaAntiHelix()
	{		
		this.setImage("images/LeftPinnaAntiHelix.jpg");
	...
	public LeftPinnaAntiHelix(BioMightPosition bioMightPosition)
	{		
		this.setImage("images/LeftPinnaAntiHelix.jpg");
	...
	public void init3D(BioMightPosition position) {
		...
		{	
			...
			System.out.println("Created LeftPinnaAntiHelix Polygon");		
			...
			if (position != null)
			{
				...
				System.out.println("Init3D - Set LeftPinnaAntiHelix TranslationX: " + position.getXPos());
			...
			{
				System.out.println("LeftPinnaAntiHelix Polygon - init3d - position is null!");
				bioMightPolygon.getTranslation().setXPos(0.0);
				bioMightPolygon.getTranslation().setYPos(0.0);
				bioMightPolygon.getTranslation().setZPos(0.0);
			}
			...
			System.out.println("Init3D - Set LeftPinnaAntiHelix Scale...");
			...
			System.out.println("Init3D - Set LeftPinnaAntiHelix Transparency...");
			...
			System.out.println("Init3D - Set LeftPinnaAntiHelix EpitheliumTissue Color...");
	...
	public String getX3D(boolean snipet) {
		...
		// Assemble the LeftPinnaAntiHelix
		String header = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
		"<!DOCTYPE X3D PUBLIC \"ISO//Web3D//DTD X3D 3.0//EN\" \"http://www.web3d.org/specifications/x3d-3.0.dtd\">\n " +
		"<X3D profile='Immersive' >\n" +
		"<head>\n" +
		 "<meta name='BioMightImage' content='LeftPinnaAntiHelix.jpg'/>\n" +
		...
		{				
			...
			{	
				...
				System.out.println("Getting X3D for LeftPinnaAntiHelixX: " + bioMightPolygon.getTranslation().getXPos());
				System.out.println("Getting X3D for LeftPinnaAntiHelixY: " + bioMightPolygon.getTranslation().getYPos());
				System.out.println("Getting X3D for LeftPinnaAntiHelixZ: " + bioMightPolygon.getTranslation().getZPos());
				// Change the height and width based on the displacement.
			
			body += "<Transform DEF='LeftPinnaAntiHelix'\n" +
			    ...
			    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
			 	"</Appearance>\n" +			    
			 	"<IndexedFaceSet DEF='LeftPinnaAntiHelixPolygon' \n" +
		...
		System.out.println("LeftPinnaAntiHelix X3D: " + body);		
