 ...
 * @author SurferJim
 *
 * Representation of the RightAuricle or Pinna, the exterior part of the ear.
 */

public class RightAuricle extends Auricle {
	private ArrayList<BioMightPropertyView> properties;
	private ArrayList<BioMightMethodView> methods;
	
	private RightPinnaAntiHelix rightPinnaAntiHelix;
	...
	public RightAuricle()
	{		
		this.setImage("images/RightAuricle.jpg");

		// Create the combonents of the Pinna
		rightPinnaAntiHelix = new RightPinnaAntiHelix();
	...
	// Create the RightAuricle of the ear using the position
	public RightAuricle(BioMightPosition bioMightPosition)
	{		
		this.setImage("images/RightAuricle.jpg");

		// Create the combonents of the Pinna
		System.out.println("Creating pinnaAntiHelix in RightAuricle Constructor..." + bioMightPosition.getXPos());
		rightPinnaAntiHelix = new RightPinnaAntiHelix(bioMightPosition);
	...
	{		
		...
		rightPinnaAntiHelix.redraw(bioMightPosition); 
	...
	public String getX3D(boolean snipet) {
		...
		"<head>\n" +
		 "<meta name='BioMightImage' content='RightAuricle.jpg'/>\n" +
		...
		System.out.println("Getting X3D RightAuricle...");
		String body =  
			rightPinnaAntiHelix.getX3D(true);
			/*
		...
		System.out.println("RightAuricle X3D: " + body);		
