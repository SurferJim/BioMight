 ...
 * @author SurferJim
 *
 * Represntation of Macula
 */
public class Macula extends EyeSenseOrgan{
	...
	public Macula()
	{
		this.setImage("images/Macula.jpg");
	...
	public String getX3D(boolean snipet) {
		...
		"<head>\n" +
		 "<meta name='BioMightImage' content='Macula.jpg'/>\n" +
		...
		System.out.println("Macula X3D: " + body);		
