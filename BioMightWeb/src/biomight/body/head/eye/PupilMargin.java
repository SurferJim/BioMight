 ...
 * @author SurferJim
 *
 * Representation of the pupil margin
 * 
 */
public class PupilMargin extends EyeSenseOrgan {
	...
	public PupilMargin()
	{
		this.setImage("images/PupilMargin.jpg");
	...
	public String getX3D(boolean snipet) {
		...
		"<head>\n" +
		 "<meta name='BioMightImage' content='PupilMargin.jpg'/>\n" +
		...
		System.out.println("PupilMargin X3D: " + body);		
