 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class Lens  extends EyeSenseOrgan {
	...
	public void initMethods() {
		...
		method.setMethodName("Focus");
		method.setHtmlType("checkbox");
		methods.add(method);	
		
		method = new BioMightMethodView();
		method.setMethodName("Distort");
		method.setHtmlType("checkbox");
		methods.add(method);
	}
	...
	public String getX3D(boolean snipet) {
		...
		"<head>\n" +
		 "<meta name='BioMightImage' content='Lens.jpg'/>\n" +
		...
		System.out.println("Lens X3D: " + body);		
