 ...
 * @author SurferJim
 *
 * Represntatoin of the optic disk
 */

public class OpticDisc extends EyeSenseOrgan {
	...
	public OpticDisc()
	{
		this.setImage("images/OpticDisc.jpg");
	...
	public String getX3D(boolean snipet) {
		...
		"<head>\n" +
		 "<meta name='BioMightImage' content='OpticDisc.jpg'/>\n" +
		...
		System.out.println("OpticDisc X3D: " + body);		
