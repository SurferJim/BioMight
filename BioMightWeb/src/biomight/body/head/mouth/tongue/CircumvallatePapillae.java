 ...
 * @author SurferJim
 *
 * Representation of the CircumvallatePapillae that reside on the Tongue
 * 
 */


public class CircumvallatePapillae extends BioMightBase {
	private ArrayList circumvallatePapillae;
	 ...
	 * 
	 * This method will instantiate the CircumvallatePapillae that are defined for the current model.  
	 * 
	 ********************************************************************************************************************/

	public CircumvallatePapillae()
	{		
	...
	public CircumvallatePapillae(String parentID)
	{		
		create(parentID, null);
	}

	
	public CircumvallatePapillae(String parentID, ArrayList<BioMightMethodView> bioMightMethods)
	{		
	 ...
	 * CREATE 
	 * 
	 * This method will instantiate the CircumvallatePapillas that are defined for the current model.  
	 * 
	 ********************************************************************************************************************/

	private void create(String parentID, ArrayList<BioMightMethodView> bioMightMethods) {

		circumvallatePapillae = new ArrayList();
		...
		try {
			// Get the information from the database via the Enterprise Bean		
			System.out.println("Getting CircumvallatePapillasInfo for ParentID: " + parentID);
			InitialContext ctx = new InitialContext();
			BioMightBeanLocal bioMightBean = (BioMightBeanLocal) ctx.lookup(Constants.BioMightBeanRef);
			bioMightTransforms = bioMightBean.getComponents(Constants.CircumvallatePapillaRef, parentID);
			System.out.println("Have CircumvallatePapillas Info from EJB");   	
		}catch (Exception e) { 
			System.out.println("Exception Getting Components - Back");
			throw new ServerException("Remote Exception getComponents():", e); 	
		}
		
		// Get the collection of CircumvallatePapillas from the database.  
		this.componentID = componentID;
		properties = new ArrayList<BioMightPropertyView>();
		
		// Run through the collection of CircumvallatePapillas and build them into the model
		// In the Default case, we get two instances of the eys, one
		// positioned on the right and one positioned on the left
		ArrayList transforms = bioMightTransforms.getTransforms();
		System.out.println("Have CircumvallatePapillas NumTransforms: " + transforms.size());
		for (int i=0; i<transforms.size(); i++)
		{
			// Get the information for the eye we are creating
			BioMightTransform bioMightTransform = (BioMightTransform) transforms.get(i);
			System.out.println("Creating CircumvallatePapilla: " + bioMightTransform.getName() + "  " + bioMightTransform.getId());
			
			componentID = bioMightTransform.getId();
			
			// Create an instance of the CircumvallatePapilla for each tranform specified for the organism
			...
			circumvallatePapillae.add(filiformPapilla);
			...
			initProperty(bioMightTransform.getName(), Constants.FoliatePapilla, Constants.FoliatePapillaRef, bioMightTransform.getId());
		}
	...
	public String getX3D(boolean snipet) {
		...
		for (int i=0; i<circumvallatePapillae.size(); i++)
		{
			
			// Get the information for the eye
			FiliformPapilla filiformPapilla = (FiliformPapilla) circumvallatePapillae.get(i);
