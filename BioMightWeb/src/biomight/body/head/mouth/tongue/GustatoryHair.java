 ...
 * @autthor SurferJim
 * 
 *  The tongue can be acted upon by messages from the brain to move and twitch
 *  responding to muscle commands.  It is also always secreting ---- into the
 *  surronding environment.
 *
 */


public class GustatoryHair extends BioMightBase {
	private ArrayList<BioMightPropertyView> properties;
	private ArrayList<BioMightMethodView> methods;



	public GustatoryHair()
	{
	...
	public String getX3D(boolean snipet) {
		...
		System.out.println("Tongue X3D: " + body);		
