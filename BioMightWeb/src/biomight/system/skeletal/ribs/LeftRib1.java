...
public class LeftRib1 extends Rib1 {
		...
		public LeftRib1()
		{
			this.setImage("images/LeftRib1.jpg");
		...
		public LeftRib1(BioMightPosition bioMightPosition)
		{
			this.setImage("images/LeftRib1.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the LeftRib1 at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the LeftRib1
			...
			{	
				...
				System.out.println("Left24Rib1CoordStr: " + coordinateString); 
				...
				for (int i=0;i<=11;i+=3)
				{
					...
					vertex.setXPos(Double.valueOf(coords[i]));
					vertex.setYPos(Double.valueOf(coords[i+1]));
					vertex.setZPos(Double.valueOf(coords[i+2])-0.75);
					System.out.println("Storing Coordinates: " + j +    "  x: " + coords[i] + " y: " + coords[i+1] + " z: " + coords[i+2]);	
					coordpoint.setBioMightPosition(j++, vertex);
				}
				...
				System.out.println("Created LeftRib1 Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set LeftRib1 TranslationX: " + position.getXPos());
					...
					System.out.println("LeftRib1 Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set LeftRib1 Scale...");
				...
				System.out.println("Init3D - Set LeftRib1 EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			// Assemble the LeftRib1
			String header = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
			"<!DOCTYPE X3D PUBLIC \"ISO//Web3D//DTD X3D 3.0//EN\" \"http://www.web3d.org/specifications/x3d-3.0.dtd\">\n " +
			"<X3D profile='Immersive' >\n" +
			"<head>\n" +
			 "<meta name='BioMightImage' content='LeftRib1.jpg'/>\n" +
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for LeftRib1X: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for LeftRib1Y: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for LeftRib1Z: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='LeftRib1'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='LeftRib1Polygon' \n" +
			...
			System.out.println("LeftRib1 X3D: " + body);		
