...
public class LeftRib3 extends Rib3 {
		...
		public LeftRib3()
		{
			this.setImage("images/LeftRib3.jpg");
		...
		public LeftRib3(BioMightPosition bioMightPosition)
		{
			this.setImage("images/LeftRib3.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the LeftRib3 at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the LeftRib3
			...
			{	
				...
				System.out.println("LeftRib3CoordStr: " + coordinateString); 
				...
				System.out.println("Created LeftRib3 Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set LeftRib3 TranslationX: " + position.getXPos());
					...
					System.out.println("LeftRib3 Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set LeftRib3 Scale...");
				...
				System.out.println("Init3D - Set LeftRib3 Transparency...");
				...
				System.out.println("Init3D - Set LeftRib3 EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			// Assemble the LeftRib3
			String header = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
			"<!DOCTYPE X3D PUBLIC \"ISO//Web3D//DTD X3D 3.0//EN\" \"http://www.web3d.org/specifications/x3d-3.0.dtd\">\n " +
			"<X3D profile='Immersive' >\n" +
			"<head>\n" +
			 "<meta name='BioMightImage' content='LeftRib3.jpg'/>\n" +
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for LeftRib3X: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for LeftRib3Y: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for LeftRib3Z: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='LeftRib3'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='LeftRib3Polygon' \n" +
			...
			System.out.println("LeftRib3 X3D: " + body);		
