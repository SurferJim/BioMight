...
public class LeftRib9 extends Rib9 {
		...
		public LeftRib9()
		{
			this.setImage("images/LeftRib9.jpg");
		...
		public LeftRib9(BioMightPosition bioMightPosition)
		{
			this.setImage("images/LeftRib9.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the LeftRib9 at Position: " + bioMightPosition.getXPos());
		...
		public String getX3D(boolean snipet) {
			...
			// Assemble the LeftRib9
			String header = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
			"<!DOCTYPE X3D PUBLIC \"ISO//Web3D//DTD X3D 3.0//EN\" \"http://www.web3d.org/specifications/x3d-3.0.dtd\">\n " +
			"<X3D profile='Immersive' >\n" +
			"<head>\n" +
			 "<meta name='BioMightImage' content='LeftRib9.jpg'/>\n" +
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for LeftRib9X: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for LeftRib9Y: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for LeftRib9Z: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='LeftRib9'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='LeftRib9Polygon' \n" +
			...
			System.out.println("LeftRib9 X3D: " + body);		
