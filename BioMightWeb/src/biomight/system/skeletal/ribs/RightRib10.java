...
public class RightRib10 extends Rib10 {
		...
		public RightRib10(BioMightPosition bioMightPosition)
		{
			this.setImage("images/RightRib10.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			initProperties();
			initMethods();
			
			System.out.println("Creating the RightRib10 at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the LeftRib6
			...
			{	
				...
				System.out.println("LeftRib6CoordStr: " + coordinateString); 
				...
				System.out.println("Created LeftRib6 Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set LeftRib6 TranslationX: " + position.getXPos());
					...
					System.out.println("LeftRib6 Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set LeftRib6 Scale...");
				...
				System.out.println("Init3D - Set LeftRib6 Transparency...");
				...
				System.out.println("Init3D - Set LeftRib6 EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			// Assemble the RightRib10
			String header = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
			"<!DOCTYPE X3D PUBLIC \"ISO//Web3D//DTD X3D 3.0//EN\" \"http://www.web3d.org/specifications/x3d-3.0.dtd\">\n " +
			"<X3D profile='Immersive' >\n" +
			"<head>\n" +
			 "<meta name='BioMightImage' content='RightRib10.jpg'/>\n" +
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for RightRib10X: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for RightRib10Y: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for RightRib10Z: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='RightRib10'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='RightRib10Polygon' \n" +
			...
			System.out.println("RightRib10 X3D: " + body);		
