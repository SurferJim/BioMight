...
public class RightRib7 extends Rib7 {
		...
		public RightRib7()
		{
			this.setImage("images/RightRib7.jpg");
		...
		public RightRib7(BioMightPosition bioMightPosition)
		{
			this.setImage("images/RightRib7.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the RightRib7 at Position: " + bioMightPosition.getXPos());
		...
		public String getX3D(boolean snipet) {
			...
			// Assemble the RightRib7
			String header = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
			"<!DOCTYPE X3D PUBLIC \"ISO//Web3D//DTD X3D 3.0//EN\" \"http://www.web3d.org/specifications/x3d-3.0.dtd\">\n " +
			"<X3D profile='Immersive' >\n" +
			"<head>\n" +
			 "<meta name='BioMightImage' content='RightRib7.jpg'/>\n" +
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for RightRib7X: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for RightRib7Y: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for RightRib7Z: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='RightRib7'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='RightRib7Polygon' \n" +
			...
			System.out.println("RightRib7 X3D: " + body);		
