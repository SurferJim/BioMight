...
public class LeftRib4 extends Rib4 {
		...
		public LeftRib4()
		{
			this.setImage("images/LeftRib4.jpg");
		...
		public LeftRib4(BioMightPosition bioMightPosition)
		{
			this.setImage("images/LeftRib4.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the LeftRib4 at Position: " + bioMightPosition.getXPos());
		...
		public String getX3D(boolean snipet) {
			...
			// Assemble the LeftRib4
			String header = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
			"<!DOCTYPE X3D PUBLIC \"ISO//Web3D//DTD X3D 3.0//EN\" \"http://www.web3d.org/specifications/x3d-3.0.dtd\">\n " +
			"<X3D profile='Immersive' >\n" +
			"<head>\n" +
			 "<meta name='BioMightImage' content='LeftRib4.jpg'/>\n" +
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for LeftRib4X: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for LeftRib4Y: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for LeftRib4Z: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='LeftRib4'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='LeftRib4Polygon' \n" +
			...
			System.out.println("LeftRib4 X3D: " + body);		
