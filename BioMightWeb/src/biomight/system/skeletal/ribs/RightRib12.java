...
public class RightRib12 extends Rib12 {
		...
		public RightRib12()
		{
			this.setImage("images/RightRib12.jpg");
		...
		public RightRib12(BioMightPosition bioMightPosition)
		{
			this.setImage("images/RightRib12.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the RightRib12 at Position: " + bioMightPosition.getXPos());
		...
		public String getX3D(boolean snipet) {
			...
			// Assemble the RightRib12
			String header = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
			"<!DOCTYPE X3D PUBLIC \"ISO//Web3D//DTD X3D 3.0//EN\" \"http://www.web3d.org/specifications/x3d-3.0.dtd\">\n " +
			"<X3D profile='Immersive' >\n" +
			"<head>\n" +
			 "<meta name='BioMightImage' content='RightRib12.jpg'/>\n" +
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for RightRib12X: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for RightRib12Y: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for RightRib12Z: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='RightRib12'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='RightRib12Polygon' \n" +
			...
			System.out.println("RightRib12 X3D: " + body);		
