...
public class RightRib8 extends Rib7 {
		...
		public RightRib8()
		{
			this.setImage("images/RightRib8.jpg");
		...
		public RightRib8(BioMightPosition bioMightPosition)
		{
			this.setImage("images/RightRib8.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the RightRib8 at Position: " + bioMightPosition.getXPos());
		...
		public String getX3D(boolean snipet) {
			...
			// Assemble the RightRib8
			String header = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
			"<!DOCTYPE X3D PUBLIC \"ISO//Web3D//DTD X3D 3.0//EN\" \"http://www.web3d.org/specifications/x3d-3.0.dtd\">\n " +
			"<X3D profile='Immersive' >\n" +
			"<head>\n" +
			 "<meta name='BioMightImage' content='RightRib8.jpg'/>\n" +
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for RightRib8X: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for RightRib8Y: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for RightRib8Z: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='RightRib8'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='RightRib8Polygon' \n" +
			...
			System.out.println("RightRib8 X3D: " + body);		
