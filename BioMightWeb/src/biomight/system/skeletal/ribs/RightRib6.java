...
public class RightRib6 extends Rib6 {
		...
		public RightRib6(BioMightPosition bioMightPosition)
		{
			this.setImage("images/RightRib2.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the RightRib2 at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			{	
				...
				coordinateString = 				
					"-3.5, " + yPos + ", -7.00," +
					"-0.5, " + yPos + ", -7.5," +
					"-0.5, " + (yPos-height) + ", -7.50," +
					"-3.5, " + (yPos-height) + ", -7.00";			
		...
		public String getX3D(boolean snipet) {
			...
			// Assemble the RightRib2
			String header = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
			"<!DOCTYPE X3D PUBLIC \"ISO//Web3D//DTD X3D 3.0//EN\" \"http://www.web3d.org/specifications/x3d-3.0.dtd\">\n " +
			"<X3D profile='Immersive' >\n" +
			"<head>\n" +
			 "<meta name='BioMightImage' content='RightRib2.jpg'/>\n" +
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for RightRib2X: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for RightRib2Y: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for RightRib2Z: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='RightRib2'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='RightRib2Polygon' \n" +
			...
			System.out.println("RightRib2 X3D: " + body);		
