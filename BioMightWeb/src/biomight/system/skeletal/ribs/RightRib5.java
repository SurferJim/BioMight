...
public class RightRib5 extends Rib5 {
		...
		public RightRib5()
		{
			this.setImage("images/RightRib5.jpg");
		...
		public RightRib5(BioMightPosition bioMightPosition)
		{
			this.setImage("images/RightRib5.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the RightRib5 at Position: " + bioMightPosition.getXPos());
	...
	public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the RightRib4
			...
			{	
				...
				System.out.println("RightRib4CoordStr: " + coordinateString); 
				...
				System.out.println("Created RightRib4 Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set RightRib4 TranslationX: " + position.getXPos());
					...
					System.out.println("RightRib4 Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set RightRib4 Scale...");
				...
				System.out.println("Init3D - Set RightRib4 Transparency...");
				...
				System.out.println("Init3D - Set RightRib4 EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			// Assemble the RightRib5
			String header = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
			"<!DOCTYPE X3D PUBLIC \"ISO//Web3D//DTD X3D 3.0//EN\" \"http://www.web3d.org/specifications/x3d-3.0.dtd\">\n " +
			"<X3D profile='Immersive' >\n" +
			"<head>\n" +
			 "<meta name='BioMightImage' content='RightRib5.jpg'/>\n" +
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for RightRib5X: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for RightRib5Y: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for RightRib5Z: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='RightRib5'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='RightRib5Polygon' \n" +
			...
			System.out.println("RightRib5 X3D: " + body);		
