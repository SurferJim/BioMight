...
public class RightRib1 extends Rib1 {
		...
		public RightRib1()
		{
			this.setImage("images/RightRib1.jpg");
		...
		public RightRib1(BioMightPosition bioMightPosition)
		{
			this.setImage("images/RightRib1.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the RightRib1 at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the RightRib1
			...
			{	
				...
				System.out.println("RightRib1CoordStr: " + coordinateString); 
				...
				System.out.println("Created RightRib1 Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set RightRib1 TranslationX: " + position.getXPos());
					...
					System.out.println("RightRib1 Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set RightRib1 Scale...");
				...
				System.out.println("Init3D - Set RightRib1 Transparency...");
				...
				System.out.println("Init3D - Set RightRib1 EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			// Assemble the RightRib1
			String header = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
			"<!DOCTYPE X3D PUBLIC \"ISO//Web3D//DTD X3D 3.0//EN\" \"http://www.web3d.org/specifications/x3d-3.0.dtd\">\n " +
			"<X3D profile='Immersive' >\n" +
			"<head>\n" +
			 "<meta name='BioMightImage' content='RightRib1.jpg'/>\n" +
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for RightRib1X: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for RightRib1Y: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for RightRib1Z: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='RightRib1'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='RightRib1Polygon' \n" +
			...
			System.out.println("RightRib1 X3D: " + body);		
