...
public class RightRib11 extends Rib11 {
		...
		public RightRib11()
		{
			this.setImage("images/RightRib11.jpg");
		...
		public RightRib11(BioMightPosition bioMightPosition)
		{
			this.setImage("images/RightRib11.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the RightRib11 at Position: " + bioMightPosition.getXPos());
		...
		public String getX3D(boolean snipet) {
			...
			// Assemble the RightRib11
			String header = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
			"<!DOCTYPE X3D PUBLIC \"ISO//Web3D//DTD X3D 3.0//EN\" \"http://www.web3d.org/specifications/x3d-3.0.dtd\">\n " +
			"<X3D profile='Immersive' >\n" +
			"<head>\n" +
			 "<meta name='BioMightImage' content='RightRib11.jpg'/>\n" +
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for RightRib11X: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for RightRib11Y: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for RightRib11Z: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='RightRib11'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='RightRib11Polygon' \n" +
			...
			System.out.println("RightRib11 X3D: " + body);		
