...
public class RightRib9 extends Rib9 {
		...
		public RightRib9()
		{
			this.setImage("images/RightRib2.jpg");
		...
		public RightRib9(BioMightPosition bioMightPosition)
		{
			this.setImage("images/RightRib9.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			initProperties();
			initMethods();
			
			System.out.println("Creating the RightRib9 at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the RightRib2
			...
			{	
				...
				coordinateString = 				
					...
					"-3.5, " + (yPos-height) + ", -6.75";			

									
				System.out.println("RightRib2CoordStr: " + coordinateString); 
				...
				System.out.println("Created RightRib2 Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set RightRib2 TranslationX: " + position.getXPos());
					...
					System.out.println("RightRib2 Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set RightRib2 Scale...");
				...
				System.out.println("Init3D - Set RightRib2 Transparency...");
				...
				System.out.println("Init3D - Set RightRib2 EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			// Assemble the RightRib9
			String header = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
			"<!DOCTYPE X3D PUBLIC \"ISO//Web3D//DTD X3D 3.0//EN\" \"http://www.web3d.org/specifications/x3d-3.0.dtd\">\n " +
			"<X3D profile='Immersive' >\n" +
			"<head>\n" +
			 "<meta name='BioMightImage' content='RightRib9.jpg'/>\n" +
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for RightRib9X: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for RightRib9Y: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for RightRib9Z: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='RightRib9'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='RightRib9Polygon' \n" +
			...
			System.out.println("RightRib9 X3D: " + body);		
