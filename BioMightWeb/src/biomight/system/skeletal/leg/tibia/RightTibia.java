 ...
 * @author SurferJim
 *
 * Representation of the Right Tibia
 * 
 */
...
public class RightTibia extends Tibia {
		...
		public RightTibia()
		{
			this.setImage("images/RightTibia.jpg");
		...
		public RightTibia(BioMightPosition bioMightPosition)
		{
			this.setImage("images/RightTibia.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the RightTibia at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the RightTibia
			...
			{	
				...
				System.out.println("RightTibiaCoordStr: " + coordinateString); 
				...
				System.out.println("Created RightTibia Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set RightTibia TranslationX: " + position.getXPos());
					...
					System.out.println("RightTibia Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set RightTibia Scale...");
				...
				System.out.println("Init3D - Set RightTibia Transparency...");
				...
				System.out.println("Init3D - Set RightTibia EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			// Assemble the RightTibia
			String header = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
			"<!DOCTYPE X3D PUBLIC \"ISO//Web3D//DTD X3D 3.0//EN\" \"http://www.web3d.org/specifications/x3d-3.0.dtd\">\n " +
			"<X3D profile='Immersive' >\n" +
			"<head>\n" +
			 "<meta name='BioMightImage' content='RightTibia.jpg'/>\n" +
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for RightTibiaX: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for RightTibiaY: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for RightTibiaZ: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='RightTibia'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='RightTibiaPolygon' \n" +
			...
			System.out.println("TightTibia X3D: " + body);		
