 ...
 * @author SurferJim
 *
 * Representation of the Left Tibia
 * 
 */
...
public class LeftTibia extends Tibia {
		...
		public LeftTibia()
		{
			this.setImage("images/LeftTibia.jpg");
		...
		public LeftTibia(BioMightPosition bioMightPosition)
		{
			this.setImage("images/LeftTibia.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the LeftTibia
			...
			{	
				...
				System.out.println("LeftTibiaCoordStr: " + coordinateString); 
				...
				System.out.println("Created LeftTibia Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set LeftTibia TranslationX: " + position.getXPos());
					...
					System.out.println("LeftTibia Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set LeftTibia Scale...");
				...
				System.out.println("Init3D - Set LeftTibia Transparency...");
				...
				System.out.println("Init3D - Set LeftTibia EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			// Assemble the LeftTibia
			String header = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
			"<!DOCTYPE X3D PUBLIC \"ISO//Web3D//DTD X3D 3.0//EN\" \"http://www.web3d.org/specifications/x3d-3.0.dtd\">\n " +
			"<X3D profile='Immersive' >\n" +
			"<head>\n" +
			 "<meta name='BioMightImage' content='LeftTibia.jpg'/>\n" +
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for LeftTibiaX: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for LeftTibiaY: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for LeftTibiaZ: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='LeftTibia'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='LeftTibiaPolygon' \n" +
			...
			System.out.println("LeftTibia X3D: " + body);		
