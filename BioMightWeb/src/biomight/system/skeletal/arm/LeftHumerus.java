 ...
 * @author SurferJim
 *
 * Representation of the Left Humerus
 * 
 */
...
public class LeftHumerus extends Humerus {
		...
		public LeftHumerus()
		{
			this.setImage("images/LeftHumerus.jpg");
		...
		public LeftHumerus(BioMightPosition bioMightPosition)
		{
			this.setImage("images/LeftHumerus.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the LeftHumerus at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the LeftHumerus
			...
			{	
				...
				coordinateString = 				
					...
					"9.25, " + (yPos-height) + ", -4.9";		

									
				System.out.println("LeftHumerusCoordStr: " + coordinateString); 
				...
				System.out.println("Created LeftHumerus Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set LeftHumerus TranslationX: " + position.getXPos());
					...
					System.out.println("LeftHumerus Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set LeftHumerus Scale...");
				...
				System.out.println("Init3D - Set LeftHumerus Transparency...");
				...
				System.out.println("Init3D - Set LeftHumerus EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for LeftHumerusX: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for LeftHumerusY: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for LeftHumerusZ: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='LeftHumerus'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='LeftHumerusPolygon' \n" +
			...
			System.out.println("LeftHumerus X3D: " + body);		
