 ...
 * @author SurferJim
 *
 * Representation of the Right Radius
 * 
 */
...
public class RightHumerus extends Humerus {
		...
		public RightHumerus()
		{
			this.setImage("images/RightHumerus.jpg");
		...
		public RightHumerus(BioMightPosition bioMightPosition)
		{
			this.setImage("images/RightHumerus.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the RightHumerus at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the RightHumerus
			...
			{	
				...
				coordinateString = 				
					"-8.75, " + yPos + ", -4.9," +
					"-7.25, " + yPos + ", -4.9," +
					"-8.75, " + (yPos-height) + ", -4.9," +
					"-10.75, " + (yPos-height) + ", -4.9";		

									
				System.out.println("RightHumerusCoordStr: " + coordinateString); 
				...
				System.out.println("Created RightHumerus Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set RightHumerus TranslationX: " + position.getXPos());
					...
					System.out.println("RightHumerus Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set RightHumerus Scale...");
				...
				System.out.println("Init3D - Set RightHumerus Transparency...");
				...
				System.out.println("Init3D - Set RightHumerus EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for RightHumerusX: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for RightHumerusY: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for RightHumerusZ: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='RightHumerus'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='RightHumerusPolygon' \n" +
			...
			System.out.println("RightHumerus X3D: " + body);		
