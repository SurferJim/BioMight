 ...
 * @author SurferJim
 *
 * Representation of the Left Radius
 * 
 */
...
public class LeftRadius extends Radius {
		...
		public LeftRadius()
		{
			this.setImage("images/LeftRadius.jpg");
		...
		public LeftRadius(BioMightPosition bioMightPosition)
		{
			this.setImage("images/LeftRadius.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the LeftRadius at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the LeftRadius
			...
			{	
				...
				System.out.println("LeftRadiusCoordStr: " + coordinateString); 
				...
				System.out.println("Created LeftRadius Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set LeftRadius TranslationX: " + position.getXPos());
					...
					System.out.println("LeftRadius Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set LeftRadius Scale...");
				...
				System.out.println("Init3D - Set LeftRadius Transparency...");
				...
				System.out.println("Init3D - Set LeftRadius EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for LeftRadiusX: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for LeftRadiusY: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for LeftRadiusZ: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='LeftRadius'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='LeftRadiusPolygon' \n" +
			...
			System.out.println("LeftRadius X3D: " + body);		
