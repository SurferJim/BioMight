...
public class RightRadius extends Radius {
		...
		public RightRadius()
		{
			this.setImage("images/RightRadius.jpg");
		...
		public RightRadius(BioMightPosition bioMightPosition)
		{
			this.setImage("images/RightRadius.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the RightRadius at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the RightRadius
			...
			{	
				...
				coordinateString = 				
					...
					"-10.8, " + (yPos-height) + ", -4.5";		

									
				System.out.println("RightRadiusCoordStr: " + coordinateString); 
				...
				System.out.println("Created RightRadius Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set RightRadius TranslationX: " + position.getXPos());
					...
					System.out.println("RightRadius Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set RightRadius Scale...");
				...
				System.out.println("Init3D - Set RightRadius Transparency...");
				...
				System.out.println("Init3D - Set RightRadius EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for RightRadiusX: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for RightRadiusY: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for RightRadiusZ: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='RightRadius'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='RightRadiusPolygon' \n" +
			...
			System.out.println("RightRadius X3D: " + body);		
