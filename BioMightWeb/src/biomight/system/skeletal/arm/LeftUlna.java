...
public class LeftUlna extends Ulna {
		...
		public LeftUlna()
		{
			this.setImage("images/LeftUlna.jpg");
		...
		public LeftUlna(BioMightPosition bioMightPosition)
		{
			this.setImage("images/LeftUlna.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the LeftUlna
			...
			{	
				...
				System.out.println("LeftUlnaCoordStr: " + coordinateString); 
				...
				System.out.println("Created LeftUlna Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set LeftUlna TranslationX: " + position.getXPos());
					...
					System.out.println("LeftUlna Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set LeftUlna Scale...");
				...
				System.out.println("Init3D - Set LeftUlna Transparency...");
				...
				System.out.println("Init3D - Set LeftUlna EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for LeftUlnaX: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for LeftUlnaY: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for LeftUlnaZ: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='LeftUlna'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='LeftUlnaPolygon' \n" +
			...
			System.out.println("LeftUlna X3D: " + body);		
