 ...
 * @author SurferJim
 *
 * Representation of the Clavicle
 * 
 */
...
public class Clavicle extends Bone {
		...
		public Clavicle()
		{
			this.setImage("images/Clavicle.jpg");
		...
		public Clavicle(BioMightPosition bioMightPosition)
		{
			this.setImage("images/Clavicle.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the Clavicle at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the Clavicle
			...
			{	
				...
				System.out.println("ClavicleCoordStr: " + coordinateString); 
				...
				System.out.println("Created Clavicle Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set Clavicle TranslationX: " + position.getXPos());
					...
					System.out.println("Clavicle Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set Clavicle Scale...");
				...
				System.out.println("Init3D - Set Clavicle Transparency...");
				...
				System.out.println("Init3D - Set Clavicle EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for ClavicleX: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for ClavicleY: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for ClavicleZ: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='Clavicle'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='ClaviclePolygon' \n" +
			...
			System.out.println("Clavicle X3D: " + body);		
