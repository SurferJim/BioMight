 ...
 * @author SurferJim
 *
 * Representation of the Ilium
 * 
 */


public class IliumOld extends Bone {
		...
		public IliumOld(BioMightPosition bioMightPosition)
		{
			this.setImage("images/Ilium.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the Ilium at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			{	
				...
				System.out.println("Created Ilium Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set Ilium TranslationX: " + position.getXPos());
				...
				System.out.println("Init3D - Set Ilium Transparency...");
				...
				System.out.println("Init3D - Set Ilium EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for IliumX: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for IliumY: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for IliumZ: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='Ilium'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='IliumPolygon' \n" +
