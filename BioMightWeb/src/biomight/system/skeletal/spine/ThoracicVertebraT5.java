...
import biomight.view.BioMightPropertyView;
	 ...
	 * @author SurferJim
	 *
	 * Representation of the ThoracicVertebraT5
	 * 
	 */
	public class ThoracicVertebraT5 extends Vertebrae {
		private BioMightPolygons bioMightPolygons;
		private ArrayList<BioMightPropertyView> properties;
		private ArrayList<BioMightMethodView> methods;
		
		
		public ThoracicVertebraT5()
		{
			this.setImage("images/ThoracicVertebraT5.jpg");
		...
		public ThoracicVertebraT5(BioMightPosition bioMightPosition)
		{
			this.setImage("images/ThoracicVertebraT5.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the ThoracicVertebraT5
			...
			{	
				...
				System.out.println("ThoracicVertebraT5CoordStr: " + coordinateString); 
				...
				System.out.println("Created ThoracicVertebraT5 Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set ThoracicVertebraT5 TranslationX: " + position.getXPos());
					...
					System.out.println("ThoracicVertebraT5 Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set ThoracicVertebraT5 Scale...");
				...
				System.out.println("Init3D - Set ThoracicVertebraT5 Transparency...");
				...
				System.out.println("Init3D - Set ThoracicVertebraT5 EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for ThoracicVertebraT5X: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for ThoracicVertebraT5Y: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for ThoracicVertebraT5Z: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='ThoracicVertebraT5'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='ThoracicVertebraT5Polygon' \n" +
			...
			System.out.println("ThoracicVertebraT5 X3D: " + body);		
