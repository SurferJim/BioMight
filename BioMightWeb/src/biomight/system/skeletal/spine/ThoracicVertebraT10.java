...
import biomight.view.BioMightPropertyView;
	 ...
	 * @author SurferJim
	 *
	 * Representation of the ThoracicVertebraT10
	 * 
	 */
	public class ThoracicVertebraT10 extends Vertebrae {
		private BioMightPolygons bioMightPolygons;
		private ArrayList<BioMightPropertyView> properties;
		private ArrayList<BioMightMethodView> methods;
		
		
		public ThoracicVertebraT10()
		{
			this.setImage("images/ThoracicVertebraT10.jpg");
		...
		public ThoracicVertebraT10(BioMightPosition bioMightPosition)
		{
			this.setImage("images/ThoracicVertebraT10.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the ThoracicVertebraT10
			...
			{	
				...
				System.out.println("ThoracicVertebraT10CoordStr: " + coordinateString); 
				...
				System.out.println("Created ThoracicVertebraT10 Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set ThoracicVertebraT10 TranslationX: " + position.getXPos());
					...
					System.out.println("ThoracicVertebraT10 Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set ThoracicVertebraT10 Scale...");
				...
				System.out.println("Init3D - Set ThoracicVertebraT10 Transparency...");
				...
				System.out.println("Init3D - Set ThoracicVertebraT10 EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for ThoracicVertebraT10X: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for ThoracicVertebraT10Y: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for ThoracicVertebraT10Z: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='ThoracicVertebraT10'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='ThoracicVertebraT10Polygon' \n" +
			...
			System.out.println("ThoracicVertebraT10 X3D: " + body);		
