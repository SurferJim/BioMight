...
import biomight.view.BioMightPropertyView;
	 ...
	 * @author SurferJim
	 *
	 * Representation of the ThoracicVertebraT3
	 * 
	 */
	public class ThoracicVertebraT3 extends Vertebrae {
		private BioMightPolygons bioMightPolygons;
		private ArrayList<BioMightPropertyView> properties;
		private ArrayList<BioMightMethodView> methods;
		
		
		public ThoracicVertebraT3()
		{
			this.setImage("images/ThoracicVertebraT3.jpg");
		...
		public ThoracicVertebraT3(BioMightPosition bioMightPosition)
		{
			this.setImage("images/ThoracicVertebraT3.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the ThoracicVertebraT3
			...
			{	
				...
				System.out.println("ThoracicVertebraT3CoordStr: " + coordinateString); 
				...
				System.out.println("Created ThoracicVertebraT3 Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set ThoracicVertebraT3 TranslationX: " + position.getXPos());
					...
					System.out.println("ThoracicVertebraT3 Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set ThoracicVertebraT3 Scale...");
				...
				System.out.println("Init3D - Set ThoracicVertebraT3 Transparency...");
				...
				System.out.println("Init3D - Set ThoracicVertebraT3 EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for ThoracicVertebraT3X: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for ThoracicVertebraT3Y: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for ThoracicVertebraT3Z: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='ThoracicVertebraT3'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='ThoracicVertebraT3Polygon' \n" +
			...
			System.out.println("ThoracicVertebraT3 X3D: " + body);		
