...
import biomight.view.BioMightPropertyView;
	 ...
	 * @author SurferJim
	 *
	 * Representation of the ThoracicVertebraT6
	 * 
	 */
	public class ThoracicVertebraT6 extends Vertebrae {
		private BioMightPolygons bioMightPolygons;
		private ArrayList<BioMightPropertyView> properties;
		private ArrayList<BioMightMethodView> methods;
		
		
		public ThoracicVertebraT6()
		{
			this.setImage("images/ThoracicVertebraT6.jpg");
		...
		public ThoracicVertebraT6(BioMightPosition bioMightPosition)
		{
			this.setImage("images/ThoracicVertebraT6.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the ThoracicVertebraT6
			...
			{	
				...
				System.out.println("ThoracicVertebraT6CoordStr: " + coordinateString); 
				...
				System.out.println("Created ThoracicVertebraT6 Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set ThoracicVertebraT6 TranslationX: " + position.getXPos());
					...
					System.out.println("ThoracicVertebraT6 Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set ThoracicVertebraT6 Scale...");
				...
				System.out.println("Init3D - Set ThoracicVertebraT6 Transparency...");
				...
				System.out.println("Init3D - Set ThoracicVertebraT6 EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for ThoracicVertebraT6X: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for ThoracicVertebraT6Y: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for ThoracicVertebraT6Z: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='ThoracicVertebraT6'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='ThoracicVertebraT6Polygon' \n" +
			...
			System.out.println("ThoracicVertebraT6 X3D: " + body);		
