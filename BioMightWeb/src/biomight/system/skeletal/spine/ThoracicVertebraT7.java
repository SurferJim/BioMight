...
import biomight.view.BioMightPropertyView;
	 ...
	 * @author SurferJim
	 *
	 * Representation of the ThoracicVertebraT7
	 * 
	 */
	public class ThoracicVertebraT7 extends Vertebrae {
		private BioMightPolygons bioMightPolygons;
		private ArrayList<BioMightPropertyView> properties;
		private ArrayList<BioMightMethodView> methods;
		
		
		public ThoracicVertebraT7()
		{
			this.setImage("images/ThoracicVertebraT7.jpg");
		...
		public ThoracicVertebraT7(BioMightPosition bioMightPosition)
		{
			this.setImage("images/ThoracicVertebraT7.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the ThoracicVertebraT7
			...
			{	
				...
				System.out.println("ThoracicVertebraT7CoordStr: " + coordinateString); 
				...
				System.out.println("Created ThoracicVertebraT7 Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set ThoracicVertebraT7 TranslationX: " + position.getXPos());
					...
					System.out.println("ThoracicVertebraT7 Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set ThoracicVertebraT7 Scale...");
				...
				System.out.println("Init3D - Set ThoracicVertebraT7 Transparency...");
				...
				System.out.println("Init3D - Set ThoracicVertebraT7 EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for ThoracicVertebraT7X: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for ThoracicVertebraT7Y: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for ThoracicVertebraT7Z: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='ThoracicVertebraT7'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='ThoracicVertebraT7Polygon' \n" +
			...
			System.out.println("ThoracicVertebraT7 X3D: " + body);		
