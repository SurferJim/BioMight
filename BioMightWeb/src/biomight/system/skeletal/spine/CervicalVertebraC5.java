...
import biomight.view.BioMightPropertyView;
	 ...
	 * @author SurferJim
	 *
	 * Representation of the CervicalVertebraC5
	 * 
	 */
	public class CervicalVertebraC5 extends Vertebrae {
		private BioMightPolygons bioMightPolygons;
		private ArrayList<BioMightPropertyView> properties;
		private ArrayList<BioMightMethodView> methods;
		
		
		public CervicalVertebraC5()
		{
			this.setImage("images/CervicalVertebraC5.jpg");
		...
		public CervicalVertebraC5(BioMightPosition bioMightPosition)
		{
			this.setImage("images/CervicalVertebraC5.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the CervicalVertebraC5 at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the CervicalVertebraC5
			...
			{	
				...
				System.out.println("CervicalVertebraC5CoordStr: " + coordinateString); 
				...
				System.out.println("Created CervicalVertebraC5 Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set CervicalVertebraC5 TranslationX: " + position.getXPos());
					...
					System.out.println("CervicalVertebraC5 Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set CervicalVertebraC5 Scale...");
				...
				System.out.println("Init3D - Set CervicalVertebraC5 Transparency...");
				...
				System.out.println("Init3D - Set CervicalVertebraC5 EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for CervicalVertebraC5X: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for CervicalVertebraC5Y: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for CervicalVertebraC5Z: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='CervicalVertebraC5'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='CervicalVertebraC5Polygon' \n" +
			...
			System.out.println("CervicalVertebraC5 X3D: " + body);		
