...
import biomight.view.BioMightPropertyView;
	 ...
	 * @author SurferJim
	 *
	 * Representation of the CoccygealVertebra3
	 * 
	 */
	public class CoccygealVertebra3 extends Vertebrae {
		private BioMightPolygons bioMightPolygons;
		private ArrayList<BioMightPropertyView> properties;
		private ArrayList<BioMightMethodView> methods;
		
		
		public CoccygealVertebra3()
		{
			this.setImage("images/CoccygealVertebra3.jpg");
		...
		public CoccygealVertebra3(BioMightPosition bioMightPosition)
		{
			this.setImage("images/CoccygealVertebra3.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the CoccygealVertebra3 at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the CoccygealVertebra3
			...
			{	
				...
				System.out.println("CoccygealVertebra3CoordStr: " + coordinateString); 
				...
				System.out.println("Created CoccygealVertebra3 Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set CoccygealVertebra3 TranslationX: " + position.getXPos());
					...
					System.out.println("CoccygealVertebra3 Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set CoccygealVertebra3 Scale...");
				...
				System.out.println("Init3D - Set CoccygealVertebra3 Transparency...");
				...
				System.out.println("Init3D - Set CoccygealVertebra3 EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			// Assemble the CoccygealVertebra3
			String header = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
			"<!DOCTYPE X3D PUBLIC \"ISO//Web3D//DTD X3D 3.0//EN\" \"http://www.web3d.org/specifications/x3d-3.0.dtd\">\n " +
			"<X3D profile='Immersive' >\n" +
			"<head>\n" +
			 "<meta name='BioMightImage' content='CoccygealVertebra3.jpg'/>\n" +
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for CoccygealVertebra3X: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for CoccygealVertebra3Y: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for CoccygealVertebra3Z: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='CoccygealVertebra3'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='CoccygealVertebra3Polygon' \n" +
			...
			System.out.println("CoccygealVertebra3 X3D: " + body);		
