...
import biomight.view.BioMightPropertyView;
	 ...
	 * @author SurferJim
	 *
	 * Representation of the CervicalVertebraC3
	 * 
	 */
	public class CervicalVertebraC3 extends Vertebrae {
		private BioMightPolygons bioMightPolygons;
		private ArrayList<BioMightPropertyView> properties;
		private ArrayList<BioMightMethodView> methods;
		
		
		public CervicalVertebraC3()
		{
			this.setImage("images/CervicalVertebraC3.jpg");
		...
		public CervicalVertebraC3(BioMightPosition bioMightPosition)
		{
			this.setImage("images/CervicalVertebraC3.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the CervicalVertebraC3 at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the CervicalVertebraC3
			...
			{	
				...
				System.out.println("CervicalVertebraC3CoordStr: " + coordinateString); 
				...
				System.out.println("Created CervicalVertebraC3 Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set CervicalVertebraC3 TranslationX: " + position.getXPos());
					...
					System.out.println("CervicalVertebraC3 Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set CervicalVertebraC3 Scale...");
				...
				System.out.println("Init3D - Set CervicalVertebraC3 Transparency...");
				...
				System.out.println("Init3D - Set CervicalVertebraC3 EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for CervicalVertebraC3X: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for CervicalVertebraC3Y: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for CervicalVertebraC3Z: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='CervicalVertebraC3'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='CervicalVertebraC3Polygon' \n" +
			...
			System.out.println("CervicalVertebraC3 X3D: " + body);		
