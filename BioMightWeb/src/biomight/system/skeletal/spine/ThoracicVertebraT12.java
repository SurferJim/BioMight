...
import biomight.view.BioMightPropertyView;
	 ...
	 * @author SurferJim
	 *
	 * Representation of the ThoracicVertebra11
	 * 
	 */

	public class ThoracicVertebraT12 extends Vertebrae {
		private BioMightPolygons bioMightPolygons;
		private ArrayList<BioMightPropertyView> properties;
		private ArrayList<BioMightMethodView> methods;
		
		
		public ThoracicVertebraT12()
		{
			this.setImage("images/ThoracicVertebraT12.jpg");
		...
		public ThoracicVertebraT12(BioMightPosition bioMightPosition)
		{
			this.setImage("images/ThoracicVertebraT12.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the ThoracicVertebraT12
			...
			{	
				...
				coordinateString = 				
					"-.5, " + yPos + ", -6.75," +
					"0.5, " + yPos + ", -6.75," +
					"0.5, " + (yPos-height) + ", -6.75," +
					"-.5, " + (yPos-height) + ", -6.75";		

									
				System.out.println("ThoracicVertebraT12CoordStr: " + coordinateString); 
				...
				System.out.println("Created ThoracicVertebraT12 Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set ThoracicVertebraT12 TranslationX: " + position.getXPos());
					...
					System.out.println("ThoracicVertebraT12 Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set ThoracicVertebraT12 Scale...");
				...
				System.out.println("Init3D - Set ThoracicVertebraT12 Transparency...");
				...
				System.out.println("Init3D - Set ThoracicVertebraT12 EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for ThoracicVertebraT12X: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for ThoracicVertebraT12Y: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for ThoracicVertebraT12Z: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='ThoracicVertebraT12'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='ThoracicVertebraT12Polygon' \n" +
			...
			System.out.println("ThoracicVertebraT12 X3D: " + body);		
