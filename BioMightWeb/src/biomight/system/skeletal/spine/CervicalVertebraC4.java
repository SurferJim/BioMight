...
import biomight.view.BioMightPropertyView;
	 ...
	 * @author SurferJim
	 *
	 * Representation of the CervicalVertebraC4
	 * 
	 */
	public class CervicalVertebraC4 extends Vertebrae {
		private BioMightPolygons bioMightPolygons;
		private ArrayList<BioMightPropertyView> properties;
		private ArrayList<BioMightMethodView> methods;
		
		
		public CervicalVertebraC4()
		{
			this.setImage("images/CervicalVertebraC4.jpg");
		...
		public CervicalVertebraC4(BioMightPosition bioMightPosition)
		{
			this.setImage("images/CervicalVertebraC4.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the CervicalVertebraC4 at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the CervicalVertebraC4
			...
			{	
				...
				System.out.println("CervicalVertebraC4CoordStr: " + coordinateString); 
				...
				System.out.println("Created CervicalVertebraC4 Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set CervicalVertebraC4 TranslationX: " + position.getXPos());
					...
					System.out.println("CervicalVertebraC4 Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set CervicalVertebraC4 Scale...");
				...
				System.out.println("Init3D - Set CervicalVertebraC4 Transparency...");
				...
				System.out.println("Init3D - Set CervicalVertebraC4 EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for CervicalVertebraC4X: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for CervicalVertebraC4Y: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for CervicalVertebraC4Z: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='CervicalVertebraC4'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='CervicalVertebraC4Polygon' \n" +
			...
			System.out.println("CervicalVertebraC4 X3D: " + body);		
