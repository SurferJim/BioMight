...
import biomight.view.BioMightPropertyView;
	 ...
	 * @author SurferJim
	 *
	 * Representation of the ThoracicVertebraT4
	 * 
	 */
	public class ThoracicVertebraT4 extends Vertebrae {
		private BioMightPolygons bioMightPolygons;
		private ArrayList<BioMightPropertyView> properties;
		private ArrayList<BioMightMethodView> methods;
		
		
		public ThoracicVertebraT4()
		{
			this.setImage("images/ThoracicVertebraT4.jpg");
		...
		public ThoracicVertebraT4(BioMightPosition bioMightPosition)
		{
			this.setImage("images/ThoracicVertebraT4.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the ThoracicVertebraT4
			...
			{	
				...
				System.out.println("ThoracicVertebraT4CoordStr: " + coordinateString); 
				...
				System.out.println("Created ThoracicVertebraT4 Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set ThoracicVertebraT4 TranslationX: " + position.getXPos());
					...
					System.out.println("ThoracicVertebraT4 Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set ThoracicVertebraT4 Scale...");
				...
				System.out.println("Init3D - Set ThoracicVertebraT4 Transparency...");
				...
				System.out.println("Init3D - Set ThoracicVertebraT4 EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for ThoracicVertebraT4X: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for ThoracicVertebraT4Y: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for ThoracicVertebraT4Z: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='ThoracicVertebraT4'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='ThoracicVertebraT4Polygon' \n" +
			...
			System.out.println("ThoracicVertebraT4 X3D: " + body);		
