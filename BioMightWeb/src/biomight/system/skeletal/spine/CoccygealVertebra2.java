...
import biomight.view.BioMightPropertyView;
	 ...
	 * @author SurferJim
	 *
	 * Representation of the CoccygealVertebra2
	 * 
	 */
	public class CoccygealVertebra2 extends Vertebrae {
		private BioMightPolygons bioMightPolygons;
		private ArrayList<BioMightPropertyView> properties;
		private ArrayList<BioMightMethodView> methods;
		
		
		public CoccygealVertebra2()
		{
			this.setImage("images/CoccygealVertebra2.jpg");
		...
		public CoccygealVertebra2(BioMightPosition bioMightPosition)
		{
			this.setImage("images/CoccygealVertebra2.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the CoccygealVertebra2 at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the CoccygealVertebra2
			...
			{	
				...
				System.out.println("CoccygealVertebra2CoordStr: " + coordinateString); 
				...
				System.out.println("Created CoccygealVertebra2 Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set CoccygealVertebra2 TranslationX: " + position.getXPos());
					...
					System.out.println("CoccygealVertebra2 Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set CoccygealVertebra2 Scale...");
				...
				System.out.println("Init3D - Set CoccygealVertebra2 Transparency...");
				...
				System.out.println("Init3D - Set CoccygealVertebra2 EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			// Assemble the CoccygealVertebra2
			String header = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
			"<!DOCTYPE X3D PUBLIC \"ISO//Web3D//DTD X3D 3.0//EN\" \"http://www.web3d.org/specifications/x3d-3.0.dtd\">\n " +
			"<X3D profile='Immersive' >\n" +
			"<head>\n" +
			 "<meta name='BioMightImage' content='CoccygealVertebra2.jpg'/>\n" +
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for CoccygealVertebra2X: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for CoccygealVertebra2Y: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for CoccygealVertebra2Z: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='CoccygealVertebra2'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='CoccygealVertebra2Polygon' \n" +
			...
			System.out.println("CoccygealVertebra2 X3D: " + body);		
