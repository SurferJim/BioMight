...
import biomight.view.BioMightPropertyView;
	 ...
	 * @author SurferJim
	 *
	 * Representation of the ThoracicVertebraT2
	 * 
	 */
	public class ThoracicVertebraT2 extends Vertebrae {
		private BioMightPolygons bioMightPolygons;
		private ArrayList<BioMightPropertyView> properties;
		private ArrayList<BioMightMethodView> methods;
		
		
		public ThoracicVertebraT2()
		{
			this.setImage("images/ThoracicVertebraT2.jpg");
		...
		public ThoracicVertebraT2(BioMightPosition bioMightPosition)
		{
			this.setImage("images/ThoracicVertebraT2.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the ThoracicVertebraT2
			...
			{	
				...
				System.out.println("ThoracicVertebraT2CoordStr: " + coordinateString); 
				...
				System.out.println("Created ThoracicVertebraT2 Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set ThoracicVertebraT2 TranslationX: " + position.getXPos());
					...
					System.out.println("ThoracicVertebraT2 Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set ThoracicVertebraT2 Scale...");
				...
				System.out.println("Init3D - Set ThoracicVertebraT2 Transparency...");
				...
				System.out.println("Init3D - Set ThoracicVertebraT2 EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for ThoracicVertebraT2X: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for ThoracicVertebraT2Y: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for ThoracicVertebraT2Z: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='ThoracicVertebraT2'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='ThoracicVertebraT2Polygon' \n" +
			...
			System.out.println("ThoracicVertebraT2 X3D: " + body);		
