...
import biomight.view.BioMightPropertyView;
	 ...
	 * @author SurferJim
	 *
	 * Representation of the CervicalVertebraC6
	 * 
	 */
	public class CervicalVertebraC6 extends Vertebrae {
		private BioMightPolygons bioMightPolygons;
		private ArrayList<BioMightPropertyView> properties;
		private ArrayList<BioMightMethodView> methods;
		
		
		public CervicalVertebraC6()
		{
			this.setImage("images/CervicalVertebraC6.jpg");
		...
		public CervicalVertebraC6(BioMightPosition bioMightPosition)
		{
			this.setImage("images/CervicalVertebraC6.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the CervicalVertebraC6 at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the CervicalVertebraC6
			...
			{	
				...
				System.out.println("CervicalVertebraC6CoordStr: " + coordinateString); 
				...
				System.out.println("Created CervicalVertebraC6 Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set CervicalVertebraC6 TranslationX: " + position.getXPos());
					...
					System.out.println("CervicalVertebraC6 Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set CervicalVertebraC6 Scale...");
				...
				System.out.println("Init3D - Set CervicalVertebraC6 Transparency...");
				...
				System.out.println("Init3D - Set CervicalVertebraC6 EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for CervicalVertebraC6X: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for CervicalVertebraC6Y: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for CervicalVertebraC6Z: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='CervicalVertebraC6'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='CervicalVertebraC6Polygon' \n" +
			...
			System.out.println("CervicalVertebraC6 X3D: " + body);		
