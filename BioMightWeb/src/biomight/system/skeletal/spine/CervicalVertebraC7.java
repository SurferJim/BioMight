...
import biomight.view.BioMightPropertyView;
	 ...
	 * 
	 */
	public class CervicalVertebraC7 extends Vertebrae {
		private BioMightPolygons bioMightPolygons;
		private ArrayList<BioMightPropertyView> properties;
		private ArrayList<BioMightMethodView> methods;
		
		
		public CervicalVertebraC7()
		{
			this.setImage("images/CervicalVertebraC7.jpg");
		...
		public CervicalVertebraC7(BioMightPosition bioMightPosition)
		{
			this.setImage("images/CervicalVertebraC7.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the CervicalVertebraC7 at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the CervicalVertebraC7
			...
			{	
				...
				coordinateString = 				
					"-.5, " + yPos + ", -5.00," +
					"0.5, " + yPos + ", -5.00," +
					"0.5, " + (yPos-height) + ", -5.00," +
					"-.5, " + (yPos-height) + ", -5.00";		

									
				System.out.println("CervicalVertebraC7CoordStr: " + coordinateString); 
				...
				System.out.println("Created CervicalVertebraC7 Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set CervicalVertebraC7 TranslationX: " + position.getXPos());
					...
					System.out.println("CervicalVertebraC7 Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set CervicalVertebraC7 Scale...");
				...
				System.out.println("Init3D - Set CervicalVertebraC7 Transparency...");
				...
				System.out.println("Init3D - Set CervicalVertebraC7 EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for CervicalVertebraC7X: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for CervicalVertebraC7Y: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for CervicalVertebraC7Z: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='CervicalVertebraC7'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='CervicalVertebraC7Polygon' \n" +
			...
			System.out.println("CervicalVertebraC7 X3D: " + body);		
