...
import biomight.view.BioMightPropertyView;
	...
	public class ThoracicVertebraT11 extends Vertebrae {
		private BioMightPolygons bioMightPolygons;
		private ArrayList<BioMightPropertyView> properties;
		private ArrayList<BioMightMethodView> methods;
		
		
		public ThoracicVertebraT11()
		{
			this.setImage("images/ThoracicVertebraT11.jpg");
		...
		public ThoracicVertebraT11(BioMightPosition bioMightPosition)
		{
			this.setImage("images/ThoracicVertebraT11.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the ThoracicVertebraT11
			...
			{	
				...
				System.out.println("ThoracicVertebraT11CoordStr: " + coordinateString); 
				...
				System.out.println("Created ThoracicVertebraT11 Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set ThoracicVertebraT11 TranslationX: " + position.getXPos());
					...
					System.out.println("ThoracicVertebraT11 Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set ThoracicVertebraT11 Scale...");
				...
				System.out.println("Init3D - Set ThoracicVertebraT11 Transparency...");
				...
				System.out.println("Init3D - Set ThoracicVertebraT11 EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for ThoracicVertebraT11X: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for ThoracicVertebraT11Y: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for ThoracicVertebraT11Z: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='ThoracicVertebraT11'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='ThoracicVertebraT11Polygon' \n" +
			...
			System.out.println("ThoracicVertebraT11 X3D: " + body);		
