...
import biomight.view.BioMightPropertyView;
	 ...
	 * @author SurferJim
	 *
	 * Representation of the CoccygealVertebra1
	 * 
	 */
	public class CoccygealVertebra1 extends Vertebrae {
		private BioMightPolygons bioMightPolygons;
		private ArrayList<BioMightPropertyView> properties;
		private ArrayList<BioMightMethodView> methods;
		
		
		public CoccygealVertebra1()
		{
			this.setImage("images/CoccygealVertebra1.jpg");
		...
		public CoccygealVertebra1(BioMightPosition bioMightPosition)
		{
			this.setImage("images/CoccygealVertebra1.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the CoccygealVertebra1 at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the CoccygealVertebra1
			...
			{	
				...
				System.out.println("CoccygealVertebra1CoordStr: " + coordinateString); 
				...
				System.out.println("Created CoccygealVertebra1 Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set CoccygealVertebra1 TranslationX: " + position.getXPos());
					...
					System.out.println("CoccygealVertebra1 Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set CoccygealVertebra1 Scale...");
				...
				System.out.println("Init3D - Set CoccygealVertebra1 Transparency...");
				...
				System.out.println("Init3D - Set CoccygealVertebra1 EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			// Assemble the CoccygealVertebra1
			String header = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
			"<!DOCTYPE X3D PUBLIC \"ISO//Web3D//DTD X3D 3.0//EN\" \"http://www.web3d.org/specifications/x3d-3.0.dtd\">\n " +
			"<X3D profile='Immersive' >\n" +
			"<head>\n" +
			 "<meta name='BioMightImage' content='CoccygealVertebra1.jpg'/>\n" +
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for CoccygealVertebra1X: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for CoccygealVertebra1Y: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for CoccygealVertebra1Z: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='CoccygealVertebra1'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='CoccygealVertebra1Polygon' \n" +
			...
			System.out.println("CoccygealVertebra1 X3D: " + body);		
