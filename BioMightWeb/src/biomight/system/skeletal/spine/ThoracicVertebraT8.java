...
import biomight.view.BioMightPropertyView;
	 ...
	 * @author SurferJim
	 *
	 * Representation of the ThoracicVertebraT8
	 * 
	 */
	public class ThoracicVertebraT8 extends Vertebrae {
		private BioMightPolygons bioMightPolygons;
		private ArrayList<BioMightPropertyView> properties;
		private ArrayList<BioMightMethodView> methods;
		
		
		public ThoracicVertebraT8()
		{
			this.setImage("images/ThoracicVertebraT8.jpg");
		...
		public ThoracicVertebraT8(BioMightPosition bioMightPosition)
		{
			this.setImage("images/ThoracicVertebraT8.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the ThoracicVertebraT8
			...
			{	
				...
				System.out.println("ThoracicVertebraT8CoordStr: " + coordinateString); 
				...
				System.out.println("Created ThoracicVertebraT8 Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set ThoracicVertebraT8 TranslationX: " + position.getXPos());
					...
					System.out.println("ThoracicVertebraT8 Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set ThoracicVertebraT8 Scale...");
				...
				System.out.println("Init3D - Set ThoracicVertebraT8 Transparency...");
				...
				System.out.println("Init3D - Set ThoracicVertebraT8 EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for ThoracicVertebraT8X: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for ThoracicVertebraT8Y: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for ThoracicVertebraT8Z: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='ThoracicVertebraT8'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='ThoracicVertebraT8Polygon' \n" +
			...
			System.out.println("ThoracicVertebraT8 X3D: " + body);		
