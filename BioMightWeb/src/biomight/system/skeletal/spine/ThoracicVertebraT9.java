...
import biomight.view.BioMightPropertyView;
	 ...
	 * @author SurferJim
	 *
	 * Representation of the ThoracicVertebraT9
	 * 
	 */
	public class ThoracicVertebraT9 extends Vertebrae {
		private BioMightPolygons bioMightPolygons;
		private ArrayList<BioMightPropertyView> properties;
		private ArrayList<BioMightMethodView> methods;
		
		
		public ThoracicVertebraT9()
		{
			this.setImage("images/ThoracicVertebraT9.jpg");
		...
		public ThoracicVertebraT9(BioMightPosition bioMightPosition)
		{
			this.setImage("images/ThoracicVertebraT9.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the ThoracicVertebraT9
			...
			{	
				...
				coordinateString = 				
					"-.5, " + yPos + ", -7.25," +
					"0.5, " + yPos + ", -7.25," +
					"0.5, " + (yPos-height) + ", -7.25," +
					"-.5, " + (yPos-height) + ", -7.25";		

									
				System.out.println("ThoracicVertebraT9CoordStr: " + coordinateString); 
				...
				System.out.println("Created ThoracicVertebraT9 Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set ThoracicVertebraT9 TranslationX: " + position.getXPos());
					...
					System.out.println("ThoracicVertebraT9 Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set ThoracicVertebraT9 Scale...");
				...
				System.out.println("Init3D - Set ThoracicVertebraT9 Transparency...");
				...
				System.out.println("Init3D - Set ThoracicVertebraT9 EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for ThoracicVertebraT9X: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for ThoracicVertebraT9Y: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for ThoracicVertebraT9Z: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='ThoracicVertebraT9'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='ThoracicVertebraT9Polygon' \n" +
			...
			System.out.println("ThoracicVertebraT9 X3D: " + body);		
