...
import biomight.view.BioMightPropertyView;
	 ...
	 * @author SurferJim
	 *
	 * Representation of the CervicalVertebraC2
	 * 
	 */
	public class CervicalVertebraC2 extends Vertebrae {
		private BioMightPolygons bioMightPolygons;
		private ArrayList<BioMightPropertyView> properties;
		private ArrayList<BioMightMethodView> methods;
		
		
		public CervicalVertebraC2()
		{
			this.setImage("images/CervicalVertebraC2.jpg");
		...
		public CervicalVertebraC2(BioMightPosition bioMightPosition)
		{
			this.setImage("images/CervicalVertebraC2.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the CervicalVertebraC2 at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the CervicalVertebraC2
			...
			{	
				...
				coordinateString = 				
					"-.5, " + yPos + ", -3.75," +
					"0.5, " + yPos + ", -3.75," +
					"0.5, " + (yPos-height) + ", -3.75," +
					"-.5, " + (yPos-height) + ", -3.75";		

									
				System.out.println("CervicalVertebraC2CoordStr: " + coordinateString); 
				...
				System.out.println("Created CervicalVertebraC2 Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set CervicalVertebraC2 TranslationX: " + position.getXPos());
					...
					System.out.println("CervicalVertebraC2 Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set CervicalVertebraC2 Scale...");
				...
				System.out.println("Init3D - Set CervicalVertebraC2 Transparency...");
				...
				System.out.println("Init3D - Set CervicalVertebraC2 EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for CervicalVertebraC2X: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for CervicalVertebraC2Y: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for CervicalVertebraC2Z: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='CervicalVertebraC2'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='CervicalVertebraC2Polygon' \n" +
			...
			System.out.println("CervicalVertebraC2 X3D: " + body);		
