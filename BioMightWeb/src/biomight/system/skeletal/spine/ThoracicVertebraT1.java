...
import biomight.view.BioMightPropertyView;
	 ...
	 * @author SurferJim
	 *
	 * Representation of the ThoracicVertebraT1
	 * 
	 */
	public class ThoracicVertebraT1 extends Vertebrae {
		private BioMightPolygons bioMightPolygons;
		private ArrayList<BioMightPropertyView> properties;
		private ArrayList<BioMightMethodView> methods;
		
		
		public ThoracicVertebraT1()
		{
			this.setImage("images/ThoracicVertebraT1.jpg");
		...
		public ThoracicVertebraT1(BioMightPosition bioMightPosition)
		{
			this.setImage("images/ThoracicVertebraT1.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the ThoracicVertebraT1
			...
			{	
				...
				System.out.println("ThoracicVertebraT1CoordStr: " + coordinateString); 
				...
				for (int i=0;i<=11;i+=3)
				{
					...
					vertex.setXPos(Double.valueOf(coords[i]));
					vertex.setYPos(Double.valueOf(coords[i+1]));
					vertex.setZPos(Double.valueOf(coords[i+2])-1.25);
					System.out.println("Storing Coordinates: " + j +    "  x: " + coords[i] + " y: " + coords[i+1] + " z: " + coords[i+2]);	
					coordpoint.setBioMightPosition(j++, vertex);
				}
				...
				System.out.println("Created ThoracicVertebraT1 Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set ThoracicVertebraT1 TranslationX: " + position.getXPos());
					...
					System.out.println("ThoracicVertebraT1 Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set ThoracicVertebraT1 Scale...");
				...
				System.out.println("Init3D - Set ThoracicVertebraT1 Transparency...");
				...
				System.out.println("Init3D - Set ThoracicVertebraT1 EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			// Assemble the ThoracicVertebraeT1
			...
			"<Scene>\n" +
			"<WorldInfo\n" +
			"title='ThoracicVertebraT1'\n" +
			"info='\"BioMight Generated X3D\"'/>\n";		

			System.out.println("*******Getting X3D for ThoracicVertebraeT1*****");
			String body = "";
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for ThoracicVertebraT1X: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for ThoracicVertebraT1Y: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for ThoracicVertebraT1Z: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='ThoracicVertebraT1'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='ThoracicVertebraT1Polygon' \n" +
			...
			System.out.println("ThoracicVertebraT1 X3D: " + body);		
