...
*
*/
public class LeftParietalBone extends Bone {
	private ArrayList<BioMightPropertyView> properties;
	private ArrayList<BioMightMethodView> methods;
	private BoneTissue boneTissue;
	
	public LeftParietalBone()
	{
		this.setImage("images/LeftParietalBone.jpg");
	...
	public String getX3D(boolean snipet) {
		...
		"<head>\n" +
		 "<meta name='BioMightImage' content='Left Parietal Bone.jpg'/>\n" +
		...
		System.out.println("LeftParietalBone X3D: " + body);		
