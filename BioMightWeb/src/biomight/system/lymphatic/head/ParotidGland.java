...
public class ParotidGland extends BioMightBase  {
	...
	public ParotidGland()
	{
		create(Constants.ParotidGlandRef, null);
	}

	
	public ParotidGland(String parentID, ArrayList<BioMightMethodView> bioMightMethods)
	{
	...
	{
		this.setImage("images/ParotidGland.jpg");
		properties = new ArrayList<BioMightPropertyView>();;	
			
		//enamel = new Enamel("Enamel", parentID, bioMightMethods);
		//initProperty("ParotidGland Enamel", Constants.Epithelium, Constants.EpitheliumRef, bioMightTransform.getId());
		System.out.println("ParotidGland Enamel completed");		
	...
	public void redraw(int parentID)
	{
		...
		*/
		System.out.println("ParotidGland Redraw");
		init3D(parentID);
	}
	...
	public String getX3D(boolean snipet) {
		...
		// Assemble the ParotidGland
		String header = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
		"<!DOCTYPE X3D PUBLIC \"ISO//Web3D//DTD X3D 3.0//EN\" \"http://www.web3d.org/specifications/x3d-3.0.dtd\">\n " +
		"<X3D profile='Immersive' >\n" +
		"<head>\n" +
		 "<meta name='BioMightImage' content='ParotidGland.jpg'/>\n" +
		...
		System.out.println("ParotidGland  X3D: " + body);		
	...
	public void setParotidGlandClass(int ParotidGlandClass)
	{
		if (ParotidGlandClass == 1)
		{
			// The Roman, or Aquiline ParotidGland
		}
		else if (ParotidGlandClass == 6)
		{
