...
public class SuperiorGlutealVein extends Artery {
	protected EndotheliumTissue endothelium;
	
	
	public SuperiorGlutealVein()
	{
		create(Constants.AxillaryArtery, null);
	}

	public SuperiorGlutealVein(String parentID)
	{
		create(parentID, null);
	}
	
	public SuperiorGlutealVein(String parentID, ArrayList<BioMightMethodView> bioMightMethods)
	{
