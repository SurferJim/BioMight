...
public class UterineVein extends Artery {
	...
	public UterineVein(String parentID)
	{
		create(parentID, null);
	}
	
	public UterineVein(String parentID, ArrayList<BioMightMethodView> bioMightMethods)
	{
