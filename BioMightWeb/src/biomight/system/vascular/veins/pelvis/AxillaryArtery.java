...
public class AxillaryArtery extends Artery {
	protected EndotheliumTissue endothelium;
	
	
	public AxillaryArtery()
	{
		create(Constants.AxillaryArtery, null);
	}

	public AxillaryArtery(String parentID)
	{
		create(parentID, null);
	}
	
	public AxillaryArtery(String parentID, ArrayList<BioMightMethodView> bioMightMethods)
	{
