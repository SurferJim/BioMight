...
public class SpermaticVein extends Artery {
	protected EndotheliumTissue endothelium;
	
	
	public SpermaticVein()
	{
		create(Constants.AxillaryArtery, null);
	}

	public SpermaticVein(String parentID)
	{
		create(parentID, null);
	}
	
	public SpermaticVein(String parentID, ArrayList<BioMightMethodView> bioMightMethods)
	{
