...
public class PosteriorJugularVein extends Vein {
	protected EndotheliumTissue endothelium;
	
	
	public PosteriorJugularVein()
	{
		create(Constants.InternalJugularVein, null);
	}

	public PosteriorJugularVein(String parentID)
	{
		create(parentID, null);
	}
	
	public PosteriorJugularVein(String parentID, ArrayList<BioMightMethodView> bioMightMethods)
	{
