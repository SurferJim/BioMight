...
public class GenicularArtery extends Artery {
	protected EndotheliumTissue endothelium;
	
	
	public GenicularArtery()
	{
		create(Constants.AxillaryArtery, null);
	}

	public GenicularArtery(String parentID)
	{
		create(parentID, null);
	}
	
	public GenicularArtery(String parentID, ArrayList<BioMightMethodView> bioMightMethods)
	{
