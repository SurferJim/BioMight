 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class EndoPlasmicReticulumSmooth extends BioMightBase{
	...
	public EndoPlasmicReticulumSmooth()
	{
		this.setImage("images/EndoPlasmicReticulumSmooth.jpg");
	...
	public EndoPlasmicReticulumSmooth(BioMightPosition position)
	{
		this.setImage("images/EndoPlasmicReticulumSmooth.jpg");
	...
	public void init3D(BioMightPosition position) {
		...
		System.out.println("Init3D - Set Translation for Smooth ER ...");
		
		// Set up the scale
		bioMightSphere.getScale().setXPos(1.5);
		bioMightSphere.getScale().setYPos(1.5);
		bioMightSphere.getScale().setZPos(1.65);
		...
		bioMightSphere.getMaterial().getDiffuseColor().setRed(0.85);
		bioMightSphere.getMaterial().getDiffuseColor().setGreen(0.55);
		bioMightSphere.getMaterial().getDiffuseColor().setBlue(0.55);
	 ...
	 * GET X3D
	 * 
	 * This method will return the X3D for the Cell.  It runs thSmooth each of its components and collects up their
	...
	public String getX3D(boolean snipet) {
		...
		"<head>" +
		 "<meta name='BioMightImage' content='EndoPlasmicReticulumSmooth.jpg'/>" +
		 "<meta name='ExportTime' content='7:45:30'/>" +
		 "<meta name='ExportDate' content='08/15/2008'/>" +
		 "<meta name='BioMight Version' content='1.0'/>" + 
		 "<meta name='FluxStudioSource' content='EndoPlasmicReticulumSmooth.fxw'/>" +
		"</head>" +
		"<Scene>" +
		"<WorldInfo" +
		"title='EndoPlasmicReticulumSmooth'" +
		"info='\"BioMight Generated X3D\">";
		
		String body = "<Transform DEF='EndoPlasmicReticulumSmooth'\n" +
		 ...
		 "<Shape DEF='EndoPlasmicReticulumSmooth'\n" +
