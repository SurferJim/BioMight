 ...
 * @author SurferJim
 *
 * Represntation of a Ganglionic Cell
 */
public class GanglionicCell extends Eucaryote {
	private ArrayList<BioMightPropertyView> properties;
	private ArrayList<BioMightMethodView> methods;
	
	
	public GanglionicCell()
	{
		this.setImage("images/GanglionicCell.jpg");
	...
	public String getX3D(boolean snipet) {
		...
		"<head>\n" +
		 "<meta name='BioMightImage' content='GanglionicCell.jpg'/>\n" +
		...
		"<Scene>\n" +
		"<WorldInfo\n" +
		"title='GanglionicCell'\n" +
		"info='\"BioMight Generated X3D\"'/>\n";		

		String body = "";//

		System.out.println("GanglionicCell X3D: " + body);		
