 ...
 * @author SurferJim
 *
 * Representation of a Horizontal Cell
 * 
 */

public class HorizontalCell extends Eucaryote  {
	...
	{
		this.setImage("images/HorizontalCell.jpg");
	...
	public String getX3D(boolean snipet) {
		...
		"<head>\n" +
		 "<meta name='BioMightImage' content='HorizontalCell.jpg'/>\n" +
		...
		"<Scene>\n" +
		"<WorldInfo\n" +
		"title='HorizontalCell'\n" +
		"info='\"BioMight Generated X3D\"'/>\n";		

		String body = "";

		System.out.println("HorizontalCell X3D: " + body);		
