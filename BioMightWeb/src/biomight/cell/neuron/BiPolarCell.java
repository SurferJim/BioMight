 ...
 * @author SurferJim
 *
 * Representation of a Bipolar Cell
 * 
 */

public class BiPolarCell extends Eucaryote {
	...
	public BiPolarCell()
	{
		this.setImage("images/BiPolarCell.jpg");
	...
	public String getX3D(boolean snipet) {
		...
		"<head>\n" +
		 "<meta name='BioMightImage' content='BiPolarCell.jpg'/>\n" +
		...
		System.out.println("BiPolarCell X3D: " + body);		
