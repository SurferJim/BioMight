...
public class StreptococcusMitis extends Bacteria {
...
private GlutamicAcid glutamicAcid;
	...
	public StreptococcusMitis(String parentID)
	{
		int localVP= Constants.VIEW_HAWKEYE;
		int localLOD = Constants.MAG1X;
	...
	public StreptococcusMitis(int hierarchy, int LOD, String parentID, ArrayList<BioMightPropertyView> bioMightProperties, ArrayList<BioMightMethodView> bioMightMethods)
	{
