...
public class Fimbriae extends BioMightBase {
private ArrayList fimbriae;
	...
	public Fimbriae(String parentID)
	{				
	...
	public Fimbriae(int localVP, int localLOD, String parentID, ArrayList<BioMightPropertyView> bioMightProperties, ArrayList<BioMightMethodView> bioMightMethods)
	{		
	...
	private void create(int localVP, int localLOD, String parentID, ArrayList<BioMightPropertyView> bioMightProperties, ArrayList<BioMightMethodView> bioMightMethods) 
	{
		...
		for (int i=0; i<transforms.size(); i++)
		{
			...
			initProperty(Constants.FimbriaRef, Constants.Fimbria, Constants.FimbriaRef, fimbria.getComponentID(), bioPos, bioScale, Constants.SINGLE_COMPONENT, bioTemplate, false);					
