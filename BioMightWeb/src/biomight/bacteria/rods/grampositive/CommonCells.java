...
public class CommonCells extends BioMightBase {
private ArrayList bacilliAnthracis;
	...
	public CommonCells(String parentID)
	{				
	...
	public CommonCells(int localVP, int localLOD, String parentID, ArrayList<BioMightPropertyView> bioMightProperties, ArrayList<BioMightMethodView> bioMightMethods)
	{		
	...
	private void create(int localVP, int localLOD, String parentID, ArrayList<BioMightPropertyView> bioMightProperties, ArrayList<BioMightMethodView> bioMightMethods) 
	{
		...
		for (int i=0; i<transforms.size(); i++)
		{
			...
			//initProperty(bioMightTransform.getName(), Constants.BacillusAnthracis, Constants.BacillusAnthracisRef, parentID);
