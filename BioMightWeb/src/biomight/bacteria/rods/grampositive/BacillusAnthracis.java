...
import biomight.bacteria.Fimbria;
 ...
 * @author SurferJim
 *
 * Representation of Bacillus Anthracis
 * 
 *****************************************************************************************/

public class BacillusAnthracis extends BioMightBase {	
	private String bacteriaName = "BacillusAnthracis";
...
private GlutamicAcid glutamicAcid;;
	...
	public BacillusAnthracis()
	{
		int localVP= Constants.VIEW_HAWKEYE;
		int localLOD = Constants.MAG1X;
		create(localVP, localLOD, Constants.BacillusAnthracisRef, null, null);
	}

	public BacillusAnthracis(String parentID)
	{
		int localVP= Constants.VIEW_HAWKEYE;
		int localLOD = Constants.MAG1X;
	...
	public BacillusAnthracis(int hierarchy, int LOD, String parentID, ArrayList<BioMightPropertyView> bioMightProperties, ArrayList<BioMightMethodView> bioMightMethods)
	{
	...
	{
		this.setImage("images/BacillusAnthracis.jpg");
		...
		if (localVP == Constants.VIEW_INTERNAL)			
		{
			...
			System.out.println("In BacillusAnthracis Create() - ViewInternal - Already Set: " + parentID);				

			
			// We already have the data for the current instance of BacillusAnthracis,
			// Go get the details for the current BacillusAnthracis is LOD is set
			if (localLOD == Constants.MAG2X)
			{
				// Go get the finer details of the BacillusAnthracis				
				System.out.println("Getting the BacillusAnthracis MAG2X : " + parentID);
				localVP = Constants.VIEW_INTERNAL; 
				localLOD = Constants.MAG1X;
				cellMembrane = new CellMembrane(localVP, localLOD, componentID, bioMightMethods);									
				System.out.println("BacillusAnthracis Instance created from SubComponents : " + parentID);
				...
				System.out.println("In BacillusAnthracis - Fimbriae is complete");
				...
				System.out.println("In BacillusAnthracis - Flagella is complete");
	
				// initialize the Properties
				//initProperty(bioMightTransform.getName(), Constants.BacillusAnthracis, Constants.BacillusAnthracisRef, bioMightTransform.getId());
			}
		...
		else if (localVP == Constants.VIEW_HAWKEYE)
		{
			...
			// This is when one is accessing a BacillusAnthracis directly
			// Get the information from the database via the Enterprise Bean		
			try {
				// Get the information from the database via the Enterprise Bean		
				System.out.println("Getting HawkEye BacillusAnthracisInfo for ParentID: " + parentID);
				InitialContext ctx = new InitialContext();
				BioMightBeanLocal bioMightBean = (BioMightBeanLocal) ctx.lookup(Constants.BioMightBeanRef);
				bioMightTransforms = bioMightBean.getComponent(parentID);
				
				System.out.println("Have BacillusAnthracis Info from EJB");   	
			}catch (Exception e) { 
				System.out.println("Exception Getting Components - BacillusAnthracis");
				throw new ServerException("Remote Exception getComponents():", e); 	
			}
				
			// Run through the collection of BacilliAnthracis and build them into the model
			// In the default case, we get one instance of the BacillusAnthracis for each eye
			ArrayList transforms = bioMightTransforms.getTransforms();
			System.out.println("BacillusAnthracis NumTransforms: " + transforms.size());
			for (int i=0; i<transforms.size(); i++)
			{
				...
				{
					System.out.println("Creating BacillusAnthracis at HawkEye MAG1X - Just Init Properties: " + parentID);
					// initialize the Properties
					initProperties();
				}
				if (localLOD == Constants.MAG2X)
				{
					// Go get the finer details of the BacillusAnthracis				
					System.out.println("Creating BacillusAnthracis at HawkEye MAG2X : " + parentID);
					localVP = Constants.VIEW_INTERNAL; 
					localLOD = Constants.MAG1X;
					...
					System.out.println("In BacillusAnthracis - CellMembrane is complete");
					...
					System.out.println("In BacillusAnthracis - Ribosomes are complete");
		...
		System.out.println("CreateBacillusAnthracis Completed");
		...
		if (bioMightMethods != null){
			System.out.println("EXECUTING BacillusAnthracis Methods: " + bioMightMethods.size());
	...
	public void initMethods() {
		...
		method = new BioMightMethodView();
		method.setDisplayName("Penetrate BacillusAnthracis");
		method.setMethodName("Penetrate BacillusAnthracis");
		method.setHtmlType("checkbox");
		method.setDataType("boolean");
		methods.add(method);	
	...
	public void generate(String parentID, String componentID)
	{
		...
		try {
			// Get the information from the database via the Enterprise Bean		
			System.out.println("Generating the BacillusAnthracis : " + componentID + "    " + parentID);
			InitialContext ctx = new InitialContext();
			bioMightBean = (BioMightBeanLocal) ctx.lookup("java:global/BioMightWeb/BioMightBean!biomight.ejb.BioMightBeanLocal");
	
			double circumference = 0.125;
			
			if (componentID.equals("BacillusAnthracis:01")) {
				
				// Generate the Palm
				double[] startPos = {3.75,-23.0,-6.0};
				double[][] currentPoints = BioGraphics.octogonXPlane(startPos, circumference);
						
				//int success = bioMightBean.generateBacillusAnthracis("BacillusAnthracis:00001", "BacillusAnthracis", 
				//		"BacillusAnthracis", componentID, parentID, currentPoints);			
				
			}
			else if (componentID.equals("BacillusAnthracis:02"))
			{
				// Generate the Elbow
				double[] startPos = {-3.75,-23.0,-6.0};
				double[][] currentPoints = BioGraphics.octogonXPlane(startPos, circumference);
				
				//int success = bioMightBean.generateBacillusAnthracis("BacillusAnthracis:00160", "BacillusAnthracis", 
				//	"BacillusAnthracis", componentID, parentID, currentPoints);
			...
			{	
				System.out.println("Calling Generate BacillusAnthracis NoParent");		
			}
			...
			System.out.println("Exception Getting Components - BacillusAnthracis");
			throw new ServerException("Remote Exception BacillusAnthracis():", e); 	
		}
	}
	 ...
	 * GET X3D
	 * 
	 * This method will return the X3D for the BacillusAnthracis.  It runs through each of its components and collects up their
	 * representations and then assembles them into one unified X3D model.
	 * 
	 ********************************************************************************************************************/
	public String getX3D(boolean snipet) {
		
		// Assembe the BacillusAnthracis
		String header = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
		"<!DOCTYPE X3D PUBLIC \"ISO//Web3D//DTD X3D 3.0//EN\" \"http://www.web3d.org/specifications/x3d-3.0.dtd\">\n " +
		"<X3D profile='Immersive' >\n" +
		"<head>\n" +
		 "<meta name='BioMightImage' content='BacillusAnthracis.jpg'/>\n" +
		...
		System.out.println("Getting X3D for BacillusAnthracis!!!!!!!!");
		...
		{	
			...
			System.out.println("Get X3D BacillusAnthracis - View Internal");
			// We do nada as the BacillusAnthracis Data is retrieved in the collection object
			// and the X3D is generated there
			if (lod == Constants.MAG2X)		
			{
				System.out.println("Get X3D BacillusAnthracis - View Internal - 2X");
			...
			{			
				...
				/*
				System.out.println("Creating BacillusAnthracis: " + bioMightTransform.getName() + "  " + bioMightTransform.getId());
				System.out.println("Creating BacillusAnthracis at Position: " + 
		...
		{
			System.out.println("Get X3D BacillusAnthracis - View Hawkeye");
			...
			if (lod == Constants.MAG2X)		
			{
				System.out.println("Get X3D BacillusAnthracis - View Hawkeye -- 2X");
				//We are going to get the X3D from the aggregation objects
			...
			{			
				// We went to the database to get data.  There will be 1 Transform record
				System.out.println("Get X3D BacillusAnthracis - View Hawkeye  1X");
		...
		body+= "<Viewpoint DEF='Viewpoint_BacillusAnthracis'\n" +
		...
		//System.out.println("BacillusAnthracis X3D: " + body);		
	...
	public void executeMethods(ArrayList<BioMightMethodView> bioMightMethods) {
		...
		for (int j=0; j<bioMightMethods.size(); j++){
			...
			System.out.println("Have BioMightMethod for BacillusAnthracis: " + bioMightMethod.getMethodName());	
			...
			if (canonicalName.equals(Constants.BacillusAnthracis)) {				
	...
	{
		// BacillusAnthracis Bacteria ferments Mannitol
		if (obj instanceof Mannitol)
		{
		}

		// BacillusAnthracis Bacteria hemolyzes Red Blood Cells
