...
public class CommonCell extends BioMightBase {	
...
private GlutamicAcid glutamicAcid;;
	...
	public CommonCell(String parentID)
	{
		int localVP= Constants.VIEW_HAWKEYE;
		int localLOD = Constants.MAG1X;
	...
	public CommonCell(int hierarchy, int LOD, String parentID, ArrayList<BioMightPropertyView> bioMightProperties, ArrayList<BioMightMethodView> bioMightMethods)
	{
