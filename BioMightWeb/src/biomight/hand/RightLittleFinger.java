...
* @author SurferJim
*
* Representation of the Right Little Finger
* 
*/
...
public class RightLittleFinger extends LittleFinger {
		...
		{
			this.setImage("images/RightLittleFinger.jpg");
		...
		public RightLittleFinger(BioMightPosition bioMightPosition)
		{
			this.setImage("images/RightLittleFinger.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the RightLittleFinger at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the RightLittleFinger
			...
			{	
				...
				coordinateString = 				
					"-12.0, " + yPos + ", -4.5," +
					"-11.5, " + yPos + ", -4.5," +
					"-12.0, " + (yPos-height) + ", -4.5," +
					"-11.5, " + (yPos-height) + ", -4.5";		
									
				System.out.println("RightLittleFingerCoordStr: " + coordinateString); 
				...
				System.out.println("Created RightLittleFinger Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set RightLittleFinger TranslationX: " + position.getXPos());
					...
					System.out.println("RightLittleFinger Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set RightLittleFinger Scale...");
				...
				System.out.println("Init3D - Set RightLittleFinger Transparency...");
				...
				System.out.println("Init3D - Set RightLittleFinger EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for RightLittleFingerX: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for RightLittleFingerY: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for RightLittleFingerZ: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='RightLittleFinger'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='RightLittleFingerPolygon' \n" +
			...
			System.out.println("RightLittleFinger X3D: " + body);		
