...
* @author SurferJim
*
* Representation of the Left Little Finger
* 
*/
...
public class LeftLittleFinger extends LittleFinger {
		...
		{
			this.setImage("images/LeftLittleFinger.jpg");
		...
		public LeftLittleFinger(BioMightPosition bioMightPosition)
		{
			this.setImage("images/LeftLittleFinger.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the LeftLittleFinger at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the LeftLittleFinger
			...
			{	
				...
				System.out.println("LeftLittleFingerCoordStr: " + coordinateString); 
				...
				System.out.println("Created LeftLittleFinger Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set LeftLittleFinger TranslationX: " + position.getXPos());
					...
					System.out.println("LeftLittleFinger Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set LeftLittleFinger Scale...");
				...
				System.out.println("Init3D - Set LeftLittleFinger Transparency...");
				...
				System.out.println("Init3D - Set LeftLittleFinger EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for LeftLittleFingerX: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for LeftLittleFingerY: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for LeftLittleFingerZ: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='LeftLittleFinger'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='LeftLittleFingerPolygon' \n" +
			...
			System.out.println("LeftLittleFinger X3D: " + body);		
