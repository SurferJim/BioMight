...
* @author SurferJim
*
* Representation of the Left Thumb
* 
*/
...
public class LeftThumb extends Thumb {
		...
		public LeftThumb()
		{
			this.setImage("images/LeftThumb.jpg");
		...
		public LeftThumb(BioMightPosition bioMightPosition)
		{
			this.setImage("images/LeftThumb.jpg");
			this.setImageHeight(300);
			this.setImageWidth(300);
			...
			System.out.println("Creating the LeftThumb at Position: " + bioMightPosition.getXPos());
		...
		public void init3D(BioMightPosition position) {
			...
			// Create a group of polygons to represent the LeftThumb
			...
			{	
				...
				System.out.println("LeftThumbCoordStr: " + coordinateString); 
				...
				System.out.println("Created LeftThumb Polygon");		
				...
				if (position != null)
				{
					...
					System.out.println("Init3D - Set LeftThumb TranslationX: " + position.getXPos());
					...
					System.out.println("LeftThumb Polygon - init3d - position is null!");
				
				// Set up the scale
				bioMightPolygon.getScale().setXPos(1);
				bioMightPolygon.getScale().setYPos(1);
				bioMightPolygon.getScale().setZPos(1);
				System.out.println("Init3D - Set LeftThumb Scale...");
				...
				System.out.println("Init3D - Set LeftThumb Transparency...");
				...
				System.out.println("Init3D - Set LeftThumb EpitheliumTissue Color...");
		...
		public String getX3D(boolean snipet) {
			...
			{				
				...
				{	
					...
					System.out.println("Getting X3D for LeftThumbX: " + bioMightPolygon.getTranslation().getXPos());
					System.out.println("Getting X3D for LeftThumbY: " + bioMightPolygon.getTranslation().getYPos());
					System.out.println("Getting X3D for LeftThumbZ: " + bioMightPolygon.getTranslation().getZPos());
					// Change the height and width based on the displacement.
				
				body += "<Transform DEF='LeftThumb'\n" +
				    ...
				    bioMightPolygon.getMaterial().getDiffuseColor().getBlue() + "'/>\n" +
				 	"</Appearance>\n" +			    
				 	"<IndexedFaceSet DEF='LeftThumbPolygon' \n" +
			...
			System.out.println("LeftThumb X3D: " + body);		
